    ...
    public class ReportsEntity
    {
        ...
        public DataSet GetReportsRowData(int reportid)
        {
            ...
            try
            {
                ...
                db.AddInParameter(dbCmd, "@MODE", DbType.String, "FETCH_ROW_DATA");
        ...
        public DataSet Geteditlistdata(int reportid)
        {
            ...
            {
                db = DatabaseFactory.CreateDatabase(DALHelper.CRM_CONNECTION_STRING);
                dbCmd = db.GetStoredProcCommand("FETCH_EXISTING_REPORT_OF_CUSTOMER_DATA");
                db.AddInParameter(dbCmd, "@REPORT_ID", DbType.Int32, reportid);
        ...
        public DataSet GetReportsListData(int reportid)
        {
            ...
            try
            {
                ...
                dbCmd = db.GetStoredProcCommand("FETCH_REPORT_WRITER_DATA");
                db.AddInParameter(dbCmd, "@REPORT_ID", DbType.Int32, reportid);
                db.AddInParameter(dbCmd, "@MODE", DbType.String, "FETCH_LIST_DATA");
                ds = db.ExecuteDataSet(dbCmd);
            }
            catch (Exception ex)
            {
        ...
        public DataSet GetReportsColumnData(int reportid)
        {
            ...
            try
            {
                ...
                dbCmd = db.GetStoredProcCommand("FETCH_REPORT_WRITER_DATA");
                db.AddInParameter(dbCmd, "@REPORT_ID", DbType.Int32, reportid);
                db.AddInParameter(dbCmd, "@MODE", DbType.String, "FETCH_COLUMN_DATA");
                ds = db.ExecuteDataSet(dbCmd);
            }
            catch (Exception ex)
            {
        ...
        public DataSet GetReportsComperatorData(int reportid)
        {
            ...
            try
            {
                ...
                dbCmd = db.GetStoredProcCommand("FETCH_REPORT_WRITER_DATA");
                db.AddInParameter(dbCmd, "@REPORT_ID", DbType.Int32, reportid);
                db.AddInParameter(dbCmd, "@MODE", DbType.String, "COMPARATOR");
                ds = db.ExecuteDataSet(dbCmd);
            }
            catch (Exception ex)
            {
        ...
        public DataSet GetExecuteddata(string sql,string column,string row)
        {
            ...
            try
            {
                ...
                db.AddInParameter(dbCmd, "@REPORT", DbType.String, "Customer");
                ds = db.ExecuteDataSet(dbCmd);
            }
            catch (Exception ex)
            {
        ...
        public DataSet getrelateddata(string passdata)
        {
            Database db = null;
            DbCommand dbCmd = null;
            DataSet ds = null;
        ...
        public DataSet getsearchresult(string passdata)
        {
            ...
            {
                db = DatabaseFactory.CreateDatabase(DALHelper.CRM_CONNECTION_STRING);
                dbCmd = db.GetStoredProcCommand("FETCH_ALL_REPORT_RELATED_SEARCH_RESULT");
                db.AddInParameter(dbCmd, "@PASS_DATA", DbType.String, passdata);
                ds = db.ExecuteDataSet(dbCmd);
            }
            catch (Exception ex)
        ...
        public DataTable selectGadgetDatarelatedto_User(int id)
        {
            Database db = null;
            DbCommand dbCmd = null;
            DataSet ds=new DataSet();
            db = DatabaseFactory.CreateDatabase(DALHelper.CRM_CONNECTION_STRING);
            dbCmd = db.GetStoredProcCommand("SELECT_REPORT_GADGET_DATA");
            db.AddInParameter(dbCmd, "@GADGET_ID", DbType.Int32,id);
            ds=db.ExecuteDataSet(dbCmd);
            return ds.Tables[0];
        }
