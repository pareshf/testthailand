...
{
   public    class SearchPurchaseVoucherStoredProcedure
    {
        ...
        public DataSet fetchallDatasearch(String sp_name, String param1, String param2, String param3, String param6, String param7, String sales_invoice)
        {
            Database db = null;
            DbCommand dbCmd = null;
            DataSet dsData = null;
            ...
            try
            {
                ...
                db.AddInParameter(dbCmd, "@SALES_INVOICE_NO", DbType.String, sales_invoice);
        ...
        public DataSet fetch_invoice_no(String sp_name, String voucher_type)
        {
            Database db = null;
            DbCommand dbCmd = null;
            DataSet dsData = null;
