<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master"
    AutoEventWireup="true" CodeBehind="CreditNote.aspx.cs" Inherits="CRM.WebApp.Views.Account.CreditNote" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
   ...
   <script language="javascript" type="text/javascript">
    ...
    <div>
        <asp:UpdatePanel ID="update_Creditnote" runat="server" Visible="true" UpdateMode="Conditional"
            ChildrenAsTriggers="false">
            <ContentTemplate>
                <asp:Label ID="Label63" runat="server" Text="Credit Note" class="pageTitle" Width="400px"
                ...
                <table width="900px" id="AccountsVoucher4" runat="server" border="1" style="border-collapse: collapse;
                    ...
                    <tr id="row1" runat="server" style="width: 1300px">
                        ...
                        <td style="width: 200px">
                            ...
                            <asp:Label ID="lbl_row1" runat="server" Text="USD"></asp:Label>
                        </td>
                        <td style="width: 200px">
                    ...
                    <tr id="row2" runat="server" style="width: 1300px; display: none">
                        ...
                        <td style="width: 200px">
                            ...
                            <asp:Label ID="Label44" runat="server" Text="USD"></asp:Label>
                        </td>
                        <td style="width: 200px">
