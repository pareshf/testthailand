<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="ContraVoucher.aspx.cs" Inherits="CRM.WebApp.Views.Account.ContraVoucher" %>
    ...
    <div>
        <asp:UpdatePanel ID="update_contra" runat="server" Visible="true" UpdateMode="Conditional"
            ...
            <ContentTemplate>
                ...
                <asp:Label ID="Label63" runat="server" Text="Contra Voucher" class="pageTitle"
                ...
                <table width="800px" id="AccountsVoucher1" runat="server" border="1" style="border-collapse: collapse;
                    ...
                    <tr style="background-color: #f3f3f3">
                        <td style="width: 120px">
                            <asp:Label ID="lblGLDate" runat="server" Text="Voucher Date" CssClass="headlabel">
                            </asp:Label>
                        </td>
                        ...
                        <td style="width: 120px">
                            ...
                            <ajax:TextBoxWatermarkExtender
                                            ID="TextBoxWatermarkExtender22" runat="server" TargetControlID="txtgldate" WatermarkText="dd/MM/yyyy" WatermarkCssClass="watermarked"></ajax:TextBoxWatermarkExtender>
                        </td>
