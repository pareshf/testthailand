<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="AdminAllBooknigsReconformed.aspx.cs" Inherits="CRM.WebApp.Views.FIT.AdminAllBooknigsReconformed" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
  ...
  <script language="javascript" type="text/javascript">
     ...
     <div>
        <asp:Label runat="server" Text="FIT - All Reconfirmed Bookings" ID="headlbl" Width="600px" Font-Bold="true"
