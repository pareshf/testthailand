<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="AllBookingsNext7Days.aspx.cs" Inherits="CRM.WebApp.Views.FIT.AllBookingsNext7Days" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
 ...
 <script language="javascript" type="text/javascript">
     ...
     <div>
        <asp:Label runat="server" Text="FIT - All Bookings To be Reconfirmed in next 7 Days" ID="headlbl" Width="600px" Font-Bold="true"
