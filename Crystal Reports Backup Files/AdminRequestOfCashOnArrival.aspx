<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="AdminRequestOfCashOnArrival.aspx.cs" Inherits="CRM.WebApp.Views.FIT.AdminRequestOfCashOnArrival" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
     ...
     <div>
        <asp:Label runat="server" Text="FIT - All Request Of Cash On Arrival" ID="headlbl" Width="600px" Font-Bold="true"
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="GV_Result" runat="server" OnSelectedIndexChanging="GV_Result_SelectedIndexChanging"
                                AutoGenerateColumns="False" SkinID="sknSubGrid" AllowPaging="false" OnPageIndexChanging="GV_Result_PageIndexChanging" pagesize="10">
