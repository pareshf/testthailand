<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master"
    AutoEventWireup="true" CodeBehind="TransferServicePrice.aspx.cs" Inherits="CRM.WebApp.Views.BackOffice.TransferServicePrice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
    ...
    <asp:Label ID="Label55" runat="server" Text="Transfer Package Price" class="pageTitle"
        Width="250px" Font-Bold="true" Font-Size="Large"></asp:Label>
    <br />
    <br />
                        ...
                        <td>
                            <asp:GridView ID="GridSiteSeeingPrice" runat="server" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ControlStyle-Width="100px" ItemStyle-HorizontalAlign="Center">
                                        <HeaderTemplate>
                                            <asp:Label ID="lblAPlusPlusmargininper" runat="server" Text="A++ Margin Amount[%]" CssClass="lblstyleGIT"></asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
