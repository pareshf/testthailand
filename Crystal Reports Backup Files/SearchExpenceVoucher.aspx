<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="SearchExpenceVoucher.aspx.cs" Inherits="CRM.WebApp.Views.Account.SearchExpenceVoucher" %>
...
<script language="javascript" type="text/javascript">
    ...
    setTimeout('RedirectToWelcomePage()', parseInt(sessionTimeout) * 60 * 1000);
     ...
     <div>
        <asp:Label runat="server" Text="Search Sales Voucher" ID="headlbl" Width="400px" Font-Bold="true"
            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="pnlMainHead" runat="server" Style="display: none">
                    <table>
                        <tr>
                            <td width="180px">
                                <asp:Label ID="Label1" runat="server" Text="Against Invoice No." CssClass="lblstyle"></asp:Label>
                            </td>
                            <td>
                        ...
                        <td>
                            <asp:GridView ID="GV_Result" runat="server" OnSelectedIndexChanging="GV_Result_SelectedIndexChanging"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="EXPENCE_VOUCHER_ID" HeaderText="Voucher Id" />
                                    ...
                                    <asp:BoundField DataField="VOUCHER_DATE" HeaderText="Date" />
