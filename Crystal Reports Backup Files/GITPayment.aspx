<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="GITPayment.aspx.cs" Inherits="CRM.WebApp.Views.GIT.GITPayment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
    ...
    <div>
    <asp:Label runat="server" Text="GIT PAYMENT" ID="lblhead" Width="200px" Font-Bold="true" Font-Size="Large" class="pageTitle"></asp:Label>
    </div>
    <br />
    <div id="paymentmode" class="pageTitle">
        <table width="475px" cellspacing="5" cellpadding="5">
            <tr>
                <td>
                    <asp:Label runat="server" Text="Payment Mode" ID="lblpaymentmode" CssClass="lblstyle"></asp:Label>
                </td>
                <td>
                    <asp:DropDownList ID="drpPayment" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drpPayment_SelectedIndexChanged" Width="233px">
                    </asp:DropDownList>
                </td>
            </tr>
        </table>
