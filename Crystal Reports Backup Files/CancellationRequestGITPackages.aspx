<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="CancellationRequestGITPackages.aspx.cs" Inherits="CRM.WebApp.Views.GITSearch.CancellationRequestGITPackages" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
     ...
     <div>
        <asp:Label runat="server" Text="GIT - All Request for Cancellation Bookings" ID="headlbl" Width="600px" Font-Bold="true"
