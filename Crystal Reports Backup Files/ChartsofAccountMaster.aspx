    ...
    <telerik:radcodeblock id="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function pageLoad() {
                ...
                if (ChartAccountTableView.PageSize = 10) {
                    CRM.WebApp.webservice.ChartsofAccountsWebService.GetChartsofAccounts(0, ChartAccountTableView.get_pageSize(), ChartAccountTableView.get_sortExpressions().toString(), ChartAccountTableView.get_filterExpressions().toDynamicLinq(), updatechartofAccounts);
                }
                else if (ChartAccountTableView.PageSize > 10) {
                    CRM.WebApp.webservice.ChartsofAccountsWebService.GetChartsofAccounts(0, ChartAccountTableView.get_pageSize(), ChartAccountTableView.get_sortExpressions().toString(), ChartAccountTableView.get_filterExpressions().toDynamicLinq(), updatechartofAccounts);
                }
                else if (ChartAccountTableView.PageSize > 20) {
            ...
            function Check(sender) {
                ...
                if (value == 0) {
                    ...
                    ChartAccountTableView.get_dataItems()[currentRowIndex - 1].findElement("OP_BALANCE").readOnly = false;

                }
                else {


                    ChartAccountTableView.get_dataItems()[currentRowIndex - 1].findElement("OP_BALANCE").readOnly = true;
            ...
            <tr>
               ...
               <RowIndicatorColumn>
                    ...
                    <telerik:GridTemplateColumn SortExpression ="OP_BALANCE" DataField="OP_BALANCE" HeaderText="OP.Balance">
                          <ItemTemplate>
                            <asp:TextBox ID="OP_BALANCE" runat="server" CssClass="radinput"  onblur="Check(this);"></asp:TextBox>
                        </ItemTemplate>  
                    </telerik:GridTemplateColumn>
                    ...
                    <telerik:GridTemplateColumn SortExpression ="OP_BAL_TYPE" DataField="OP_BAL_TYPE" HeaderText="OP.Balance Type">
                     ...
                     <telerik:GridTemplateColumn SortExpression ="CL_BALANCE" DataField="CL_BALANCE" HeaderText="CL.Balance" visible="false">
                          <ItemTemplate>
                            <asp:TextBox ID="CL_BALANCE" runat="server" CssClass="radinput" ></asp:TextBox>
                        </ItemTemplate>  
                    </telerik:GridTemplateColumn>

                    <telerik:GridTemplateColumn SortExpression ="CL_BAL_TYPE" DataField="CL_BAL_TYPE" HeaderText="CL.Balance Type" visible="false">
                          <ItemTemplate>
