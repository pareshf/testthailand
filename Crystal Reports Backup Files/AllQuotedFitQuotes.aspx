<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="AllQuotedFitQuotes.aspx.cs" Inherits="CRM.WebApp.Views.FIT.AllQuotedFitQuotes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
 ...
 <script language="javascript" type="text/javascript">
    ...
    <div>
        <asp:Label runat="server" Text="FIT - All Quotes" ID="headlbl" Width="600px" Font-Bold="true"
