<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master"
    AutoEventWireup="true" CodeBehind="SearchPurchaseCancellation.aspx.cs" Inherits="CRM.WebApp.Views.Account.SearchPurchaseCancellation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
 ...
 <script language="javascript" type="text/javascript">
    ...
    <div>
        <asp:Label runat="server" Text="Search Purchase Cancellation" ID="headlbl" Width="400px"
