<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="CustomerMaster2.aspx.cs" Inherits="CRM.WebApp.Views.Administration.CustomerMaster2" %>
...
//                            $("#ctl00_cphPageContent_cutomertravelhistorywithother_ctl00_ctl" + i + "_TOUR_TYPE_NAME").autocomplete(toursubtype);
    ...
    <br />
        ...
        <table>
            <tr>
                <td>
                    <telerik:radgrid id="cutomertravelhistorywithother" runat="server" allowpaging="true" allowmultirowselection="false"
                        allowsorting="True" pagesize="10" itemstyle-wrap="false" enableembeddedskins="false"
                        allowautomaticdeletes="True" allowautomaticinserts="True">
               <MasterTableView ClientDataKeyNames="SR_NO" AllowMultiColumSorting="true" EditMode ="InPlace" Width="1000px">
               <RowIndicatorColumn>
