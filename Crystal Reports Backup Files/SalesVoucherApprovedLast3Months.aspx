<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="SalesVoucherApprovedLast3Months.aspx.cs" Inherits="CRM.WebApp.Views.Account.SalesVoucherApprovedLast3Months" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
 <script language="javascript" type="text/javascript">
     ...
     <div>
        <asp:Label runat="server" Text="Sales Voucher Approved Last 3 Months" ID="headlbl" Width="400px" Font-Bold="true"
