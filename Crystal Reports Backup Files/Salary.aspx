<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master"
    AutoEventWireup="true" CodeBehind="Salary.aspx.cs" Inherits="CRM.WebApp.Views.Account.Salary" %>
  ...
  <script language="javascript" type="text/javascript">
    ...
    <div>
                    ...
                    <asp:UpdatePanel ID="update_contra" runat="server" Visible="true" UpdateMode="Conditional"
                        ...
                        <ContentTemplate>
                            ...
                            <asp:Label ID="Label63" runat="server" Text="Salary Voucher" class="pageTitle" Width="400px"
                                Font-Bold="true" Font-Size="Large"></asp:Label>
                            <br />
                            <br />
                            <table width="400px" id="AccountsVoucher1" runat="server" border="1" style="border-collapse: collapse;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="lblsal" runat="server" Text="Employee Salary :"></asp:Label>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label2" runat="server" Text="Voucher No"></asp:Label>
                                        
                                    </td>
                                    <td>
                                        
                                        <asp:Label ID="lbl_voucher_no" runat="server"></asp:Label>
                                    </td>
                                </tr>

                                <tr>
                                    <td>
                                        <asp:Label ID="Label3" runat="server" Text="GL Date"></asp:Label>
    ...
    <div id="voucher_status" runat="server">
        <asp:UpdatePanel ID="UpdatePanel2" runat="server" Visible="true" UpdateMode="Conditional"
            ChildrenAsTriggers="false">
            <ContentTemplate>
                <table width="300px" id="AccountsVoucher2" runat="server" border="1" style="border-collapse: collapse;
                    border-color: #E6E6E6 #E6E6E6 #CCCCCC" cellspacing="5" cellpadding="5">
