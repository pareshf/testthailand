<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AgentBookingStatus.ascx.cs" Inherits="CRM.WebApp.Views.MyGadgets.AgentBookingStatus" %>
				...
				<tr>
					<td>
						<asp:CHART id="Chart1" runat="server" Palette="None"
                            ...
                            PaletteCustomColors="80, 180, 50; 5, 141, 199; 147,  54, 168; SkyBlue; 255, 128, 128; 237, 86, 27; 255, 178, 13; 122, 126, 129; ">
							<legends>
