<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master"
    AutoEventWireup="true" CodeBehind="SearchSalaryVoucher.aspx.cs" Inherits="CRM.WebApp.Views.Account.SearchSalaryVoucher" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
 ...
 <script language="javascript" type="text/javascript">
    ...
    <div>
        <asp:Label runat="server" Text="Search Salary Voucher" ID="headlbl" Width="400px"
                        ...
                        <td>
                            <asp:GridView ID="GV_Result" runat="server" OnSelectedIndexChanging="GV_Result_SelectedIndexChanging"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="SALARY_VOUCHER_ID" HeaderText="Voucher Id" />
