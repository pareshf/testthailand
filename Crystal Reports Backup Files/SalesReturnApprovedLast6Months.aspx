<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="SalesReturnApprovedLast6Months.aspx.cs" Inherits="CRM.WebApp.Views.Account.SearchPages.SalesReturnApprovedLast6Months" %>
...
<style>
     ...
     <div>
        <asp:Label runat="server" Text="Sales Return Approved Last 6 Months" ID="headlbl" Width="400px" Font-Bold="true"
                ...
                <asp:Panel ID="pnlMainHead" runat="server" Style="display: none">
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="drp_invoice" runat="server" Width="255px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                       <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="drp_Voucher_types" runat="server" Width="255px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="drp_Voucher_status1" runat="server" Width="255px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="GV_Result" runat="server" OnSelectedIndexChanging="GV_Result_SelectedIndexChanging"
                                AutoGenerateColumns="False" SkinID="sknSubGrid" AllowPaging="true" OnPageIndexChanging="GV_Result_PageIndexChanging" pagesize="10" Width="1100px">
