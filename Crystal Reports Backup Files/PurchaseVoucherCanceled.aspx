<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="PurchaseVoucherCanceled.aspx.cs" Inherits="CRM.WebApp.Views.Account.PurchaseVoucherCanceled" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
 ...
 <script language="javascript" type="text/javascript">
     ...
     <div>
        <asp:Label runat="server" Text="Purchase Voucher Canceled" ID="headlbl" Width="400px" Font-Bold="true"
