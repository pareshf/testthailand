<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master"
    AutoEventWireup="true" CodeBehind="PaymentToBeReceived.aspx.cs" Inherits="CRM.WebApp.Views.MIS.PaymentToBeReceived" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
    ...
    <div class="pageTitle">
        <asp:Literal ID="lblPageAddress" runat="server" Text="Payments To be Received Reports"></asp:Literal>
    </div>
    <div>
    ...
    <table>
        <tr>
            <td>
                <asp:Label ID="lblfromdate" runat="server" Text="Invoice From Date"></asp:Label>
            </td>
            <td>
                ...
                <asp:RequiredFieldValidator ID="reqMobile" runat="server" ControlToValidate="txtfromdate"
                    ErrorMessage="Invoice From Date is required." ValidationGroup="valid"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="Label1" runat="server" Text="Invoice To Date"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="TextBox1" runat="server" Width="<%$appSettings:TextBoxWidth%>" Visible="true"
                    ...
                    ErrorMessage="Invoice To Date is required." ValidationGroup="valid"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="Label3" runat="server" Text="Tour From Date"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="TextBox2" runat="server" Width="<%$appSettings:TextBoxWidth%>" Visible="true"
                    onclick="showPopup(this, event);" onfocus="showPopup(this, event);" onkeydown="parseDate(this, event);"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="Label4" runat="server" Text="Tour To Date"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="TextBox3" runat="server" Width="<%$appSettings:TextBoxWidth%>" Visible="true"
                    onclick="showPopup(this, event);" onfocus="showPopup(this, event);" onkeydown="parseDate(this, event);"></asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:DropDownList ID="drpagentcompany" runat="server">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
