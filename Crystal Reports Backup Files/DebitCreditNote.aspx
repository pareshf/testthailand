<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master"
    AutoEventWireup="true" CodeBehind="DebitCreditNote.aspx.cs" Inherits="CRM.WebApp.Views.Account.DebitCreditNote" %>
 ...
 <script language="javascript" type="text/javascript">
    ...
    <div>
        <asp:UpdatePanel ID="update_voucher" runat="server" Visible="true" UpdateMode="Conditional"
            ...
            <ContentTemplate>
                <asp:Label ID="Label63" runat="server" Text="Debit/Credit Note Voucher" class="pageTitle"
                ...
                <table width="800px" id="AccountsVoucher1" runat="server" border="1" style="border-collapse: collapse;
                    ...
                    <tr id="Tr1" style="background-color: #f3f3f3" runat="server" visible="false">
                        ...
                        <td>
                            <asp:DropDownList ID="drp_account_grp" runat="server" Width="155px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr id="Tr2" style="background-color: #f3f3f3" runat="server" visible="false">
                        ...
                        <td>
                            <asp:DropDownList ID="drp_gl_code" runat="server" Width="155px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <%----------------------------------------------END------------------------------------------------%>
                    ...
                    <tr style="background-color: #f3f3f3" id="Tr4" runat="server">
                        <td>
                            <asp:Label ID="Label8" runat="server" Text="Voucher No" CssClass="headlabel">
                            </asp:Label>
                        </td>
                        <td>
                    ...
                    <tr style="background-color: #f3f3f3" id="Tr3" runat="server" visible="false">
                        <td>
                            <asp:Label ID="Label5" runat="server" Text="GL Date" CssClass="headlabel">
                            </asp:Label>
                        </td>
                        <td>
                    ...
                    <tr style="background-color: #f3f3f3" id="id_6" runat="server" visible="false">
                        <td>
                            <asp:Label ID="Label82" runat="server" Text="Credit Note Amount" CssClass="headlabel">
                            </asp:Label>
                        </td>
                        <td>
                     ...
                     <tr style="background-color: #f3f3f3" id="Tr5" runat="server" visible="false">
                        <td>
                            <asp:Label ID="Label9" runat="server" Text="Invoice Amount" CssClass="headlabel">
                            </asp:Label>
                        </td>
                        <td>
