<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master"
    AutoEventWireup="true" CodeBehind="ExpencePayment.aspx.cs" Inherits="CRM.WebApp.Views.Account.ExpencePayment" %>
 ...
 <script language="javascript" type="text/javascript">
    ...
    <div>
        <asp:UpdatePanel ID="update_voucher" runat="server" Visible="true" UpdateMode="Conditional"
            ...
            <ContentTemplate>
                <asp:Label ID="Label63" runat="server" Text="Expence Payment Voucher" class="pageTitle"
                    Width="300px" Font-Bold="true" Font-Size="Large"></asp:Label>
                <br />
                <br />
                <table width="800px" id="AccountsVoucher1" runat="server" border="1" style="border-collapse: collapse;
                    ...
                    <tr style="background-color: #f3f3f3">
                        ...
                        <td>
                            <asp:DropDownList ID="drpvoucher_type" runat="server" Width="155px" AutoPostBack="true">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr id="Tr0" style="background-color: #f3f3f3" runat="server">
                        <td>
                            <asp:Label ID="lbl_expdate" runat="server" Text="Invoice Date" CssClass="headlabel">
                            </asp:Label>
                        </td>
                        <td>
                    ...
                    <tr id="Tr1" style="background-color: #f3f3f3" runat="server">
                        <td>
                            <asp:Label ID="Label2" runat="server" Text="GL Date" CssClass="headlabel">
                            </asp:Label>
                        </td>
                        <td>
                    ...
                    <tr id="Trinvoice" style="background-color: #f3f3f3" runat="server">
                        ...
                        <td>
                            <asp:DropDownList ID="drp_invoice" runat="server" Width="155px" OnSelectedIndexChanged="drpinvoice_SelectedIndexChanged"
                                AutoPostBack="true">
                            </asp:DropDownList>
                        </td>
                    </tr>
