<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="SupplierReports.aspx.cs" Inherits="CRM.WebApp.Views.MIS.SupplierReports" %>
...
<style>
    ...
    <asp:Label runat="server" Text="Supplier Reports" ID="headlbl" Width="200px" Font-Bold="true"
    ...
    <div id="paymentmode" class="pageTitle">
        <table width="475px" cellspacing="5" cellpadding="5">
            <tr>
                <td width="220px">
                    <asp:Label runat="server" Text="Supplier Name" ID="payment_mode" CssClass="lblstyle"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td width="220px">
                    <asp:Label runat="server" Text="From Invoice Date" ID="Label1" CssClass="lblstyle"></asp:Label>
                </td>
                <td>
     ...
     <ajax:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender21" runat="server" TargetControlID="txt_fromdate"
            ...
            <tr>
                <td width="220px">
                    <asp:Label runat="server" Text="To Invoice Date" ID="Label2" CssClass="lblstyle"></asp:Label>
                </td>
                <td>
