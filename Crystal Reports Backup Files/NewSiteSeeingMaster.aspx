<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="NewSiteSeeingMaster.aspx.cs" Inherits="CRM.WebApp.Views.Administration.NewSiteSeeingMaster" %>
    ...
    <telerik:radcodeblock id="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function pageLoad() {
                ...
                if (siteTabelView.PageSize = 10) {
                    CRM.WebApp.webservice.SiteMasterWebService.GetSiteDetails(0, siteTabelView.get_pageSize(), siteTabelView.get_sortExpressions().toString(), siteTabelView.get_filterExpressions().toDynamicLinq(), updatesiteGrid);
                }
                else if (siteTabelView.PageSize > 10) {
                    CRM.WebApp.webservice.SiteMasterWebService.GetSiteDetails(0, siteTabelView.get_pageSize(), siteTabelView.get_sortExpressions().toString(), siteTabelView.get_filterExpressions().toDynamicLinq(), updatesiteGrid);
                }
                else if (siteTabelView.PageSize > 20) {
                    CRM.WebApp.webservice.SiteMasterWebService.GetSiteDetails(0, siteTabelView.get_pageSize(), siteTabelView.get_sortExpressions().toString(), siteTabelView.get_filterExpressions().toDynamicLinq(), updatesiteGrid);
                }
            ...
            function addnewsitedetail(sender, args) {
                ...
                ary[4] = sender.parentNode.parentNode.parentNode.parentNode.parentNode.children[0].control._dataItems[sender.parentNode.parentNode.rowIndex - 1]._dataItem.SIGHT_SEEING_SRNO;
                for (i = 0; i < 5; i++) {
     ...
     <div id = "radmastergrid">
        ...
        <table>
            ...
            <Resizing AllowColumnResize="true" ResizeGridOnColumnResize="true" />
                <ClientEvents OnCommand="radgridsitemaster_Command" OnRowSelected="radgridsitemaster_RowSelected" OnRowDblClick="addNewsSiteseeing"/>
        ...
        <asp:Literal ID="Literal2" runat="server" Text="Upload Image :"></asp:Literal>
               ...
               <ClientSettings ReorderColumnsOnClient="true" AllowDragToGroup="true"
                AllowColumnsReorder="True">
                 <KeyboardNavigationSettings AllowActiveRowCycle="true"/>
            <Resizing AllowColumnResize="true" ResizeGridOnColumnResize="true" />
                <ClientEvents OnCommand="radgridphotomaster_Command" OnRowSelected="radgridphotomaster_RowSelected" OnRowDblClick="addNewPhotoDetails"/>
                <Selecting AllowRowSelect="true"/>
            </ClientSettings> 
               </telerik:radgrid>
