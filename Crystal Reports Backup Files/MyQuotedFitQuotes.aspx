<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="MyQuotedFitQuotes.aspx.cs" Inherits="CRM.WebApp.Views.FIT.MyQuotedFitQuotes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
 ...
 <script language="javascript" type="text/javascript">
    ...
    <div>
        <asp:Label runat="server" Text="FIT - My Quotes" ID="headlbl" Width="200px" Font-Bold="true"
