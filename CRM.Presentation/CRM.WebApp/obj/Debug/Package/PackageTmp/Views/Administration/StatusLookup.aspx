<%@ Page Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true"
    CodeBehind="StatusLookup.aspx.cs" Inherits="CRM.WebApp.Views.Administration.StatusLookup"
    Title="Untitled Page" %>
...
<asp:Content ID="cntIncludes" ContentPlaceHolderID="cphIncludes" runat="server">
    ...
    <script type="text/javascript" language="javascript">
		...
		function ramrequeststarted(ajaxmanager, eventargs) {
            ...
            if (eventargs.eventtarget == "ctl00$cphpagecontent$acbstatus$imgexcelexport" || eventargs.eventtarget == "ctl00$cphpagecontent$acbstatus$imgwordexport" || eventargs.eventtarget == "ctl00$cphpagecontent$acbstatus$imgpdfexport" || eventargs.eventtarget == "ctl00$cphpagecontent$acbstatus$imgcsvexport") {
...
<asp:Content ID="cntPageContent" ContentPlaceHolderID="cphPageContent" runat="server">
    <telerik:RadAjaxManager ID="RadAjaxManager" runat="server">
        ...
        <ajaxsettings>
            <telerik:AjaxSetting AjaxControlID="ctl00$cphPageContent$acbStatus$imgExcelExport">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="upGrid" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="ctl00$cphPageContent$acbStatus$imgWordExport">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="upGrid" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="ctl00$cphPageContent$acbStatus$imgPdfExport">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="upGrid" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="ctl00$cphPageContent$acbStatus$imgCsvExport">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="upGrid" />
                </UpdatedControls>
            </telerik:AjaxSetting>
    ...
    <div class="pageTitle">
        <asp:Literal ID="lblPageTitle" runat="server" Text="Status"></asp:Literal>
    </div>
    <asp:UpdatePanel ID="upActionBar" runat="server" UpdateMode="Always">
        <ContentTemplate>
            <crmUC:ActionBar ID="acbStatus" runat="server" OnbtnNewClick="acbStatus_NewClick"
                OnbtnSaveClick="acbStatus_SaveClick" OnbtnCancelClick="acbStatus_CancelClick"
                OnbtnDeleteClick="acbStatus_DeleteClick" OnbtnEditClick="acbStatus_EditClick"
                OnbtnSearchClick="acbStatus_SearchClick" SaveButtonValidationGroup="ReqStatusName"
                OnbtnSaveNewClick="acbStatus_SaveNewClick" SaveNewButtonValidationGroup="ReqStatusName"
                OnimgExcelExport_Click="acbStatus_ExcelExportClick" OnimgCsvExport_Click="acbStatus_CsvExportClick"
                OnimgPdfExport_Click="acbStatus_PdfExportClick" OnimgWordExport_Click="acbStatus_WordExportClick" />
            <table width="65%">
                <tr>
                    <td>
                        <asp:UpdatePanel ID="upAddNew" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Panel ID="pnlAddNewMode" runat="server" Visible="false">
                                    <table width="100%" class="TableForm" cellspacing="0" cellpadding="4">
                                        <tr>
                                            <th>
                                                <asp:Literal runat="server" ID="ltlTableHeader" Text="New Status"></asp:Literal>
                                            </th>
                                            <th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtStatusName" runat="server" ValidationGroup="ReqStatusName" Width="<%$appSettings:TextBoxWidth %>"
                                                    MaxLength="25"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="requireStatusName" runat="server" ControlToValidate="txtStatusName"
                                                    ValidationGroup="ReqStatusName" Display="Dynamic" ErrorMessage="<br />Enter Valid Status Name"
                            ...
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="acbStatus" />
                            </Triggers>
                        </asp:UpdatePanel>
                    </td>
                </tr>
                            ...
                            <ContentTemplate>
                                <asp:Panel ID="pnlGrid" runat="server">
                                    <table width="100%" cellpadding="0" border="0">
                                        <tr>
                                            <td>
                                                <telerik:RadGrid ID="radgrdStatus" runat="server" AutoGenerateColumns="false" AllowMultiRowSelection="true"
                                                    AllowMultiRowEdit="true" AllowPaging="true" AllowSorting="true" ClientSettings-EnableRowHoverStyle="true"
                                                    EnableEmbeddedSkins="false" OnPreRender="radgrdStatus_PreRender" OnItemDataBound="radgrdStatus_ItemDataBound"
                                                    OnNeedDataSource="radgrdStatus_NeedDataSource" PageSize="<%$appSettings:GridPageSize %>"
                                                    Width="100%">
                                                    <clientsettings>
                                                    ...
                                                    <mastertableview autogeneratecolumns="False" editmode="InPlace" allowsorting="True"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <telerik:GridTemplateColumn HeaderText="Id" UniqueName="STATUS_ID" Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblGrdStatusIdItem" runat="server" Text='<%# Bind("STATUS_ID") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <EditItemTemplate>
                                                                    <asp:Label ID="lblGrdStatusIdEdit" runat="server" Text='<%# Bind("STATUS_ID") %>'></asp:Label>
                                                                </EditItemTemplate>
                                                            </telerik:GridTemplateColumn>
                                                            <telerik:GridTemplateColumn HeaderText="Status" UniqueName="STATUS_NAME" SortExpression="STATUS_NAME">
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                                <HeaderTemplate>
                                                                    <asp:LinkButton ID="lnkbtnGrdStatusName" runat="server" Title="Click here to Sort"
                                                                        CommandName='Sort' CommandArgument='STATUS_NAME' />
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblGrdStatusName" runat="server" Text='<%# Bind("STATUS_NAME") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <EditItemTemplate>
                                                                    <asp:TextBox ID="txtGrdStatusName" runat="server" Text='<%# Bind("STATUS_NAME") %>'
                                                                        MaxLength="25"></asp:TextBox>
                                                                    <span class="error">*</span>
                                                                    <asp:RequiredFieldValidator ID="rfvStatusName" runat="server" ControlToValidate="txtGrdStatusName"
                                                                        ValidationGroup="ReqStatusName" Display="Dynamic" ErrorMessage="<br />Enter Valid Status Name"
                                                                        CssClass="error"></asp:RequiredFieldValidator>
                                                                </EditItemTemplate>
                                                            </telerik:GridTemplateColumn>
