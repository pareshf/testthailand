<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master"
    AutoEventWireup="true" CodeBehind="EmailTemplateLookup.aspx.cs" Inherits="CRM.WebApp.Views.Administration.EmailTemplateLookup" %>
    ...
    <script type="text/javascript" language="javascript">
		...
		window.blockConfirm = function(text, mozEvent, oWidth, oHeight, callerObj, oTitle) 
		{
            ...
            //alert(eventArgs.EventTarget);
			      if (eventArgs.EventTarget == "ctl00$cphPageContent$acbEmailTemplate$imgExcelExport" || eventArgs.EventTarget == "ctl00$cphPageContent$acbEmailTemplate$imgWordExport" || eventArgs.EventTarget == "ctl00$cphPageContent$acbEmailTemplate$imgPdfExport" || eventArgs.EventTarget == "ctl00$cphPageContent$acbEmailTemplate$imgCsvExport") {
...
<asp:Content ID="cntPageContent" ContentPlaceHolderID="cphPageContent" runat="server">
    ...
    <div class="pageTitle">
        <asp:Literal ID="lblPageTitle" runat="server" Text="Email Template"></asp:Literal>
    </div>
    <asp:UpdatePanel ID="upActionBar" runat="server" UpdateMode="Always">
        <ContentTemplate>
            <crmUC:ActionBar ID="acbEmailTemplate" runat="server" OnbtnSaveClick="acbEmailTemplate_SaveClick"
                OnbtnCancelClick="acbEmailTemplate_CancelClick" OnbtnNewClick="acbEmailTemplate_NewClick"
                OnbtnEditClick="acbEmailTemplate_EditClick" OnbtnDeleteClick="acbEmailTemplate_DeleteClick"
                OnbtnSearchClick="acbEmailTemplate_SearchClick" OnbtnSaveNewClick="acbEmailTemplate_SaveNewClick"
                SaveButtonValidationGroup="ReqRelationName" SaveNewButtonValidationGroup="ReqRelationName"
                OnimgExcelExport_Click="acbEmailTemplate_ExcelExportClick" OnimgCsvExport_Click="acbEmailTemplate_CsvExportClick"
                OnimgPdfExport_Click="acbEmailTemplate_PdfExportClick" OnimgWordExport_Click="acbEmailTemplate_WordExportClick"
                OnbtnRefreshClick="acbEmailTemplate_RefreshClick" />
        </ContentTemplate>
    </asp:UpdatePanel>
    <table width="60%">
        <tr>
            <td>
                <asp:UpdatePanel ID="upAddNew" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Panel ID="pnlAddNewMode" runat="server" Visible="false">
                            <table width="100%" class="TableForm" cellspacing="0" cellpadding="4">
                                <tr>
                                    <th>
                                        <asp:Literal runat="server" ID="ltlTableHeader" Text="New Email Template"></asp:Literal>
                                    </th>
                                    <th>
                                ...
                                <tr>
                                    <td style="width: 150px">
                                        <asp:Label ID="lblRelationDesc" runat="server" Text="Email Template Name:"></asp:Label>
                                        <span class="error">*</span>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtEmailTemplateDesc" runat="server" ToolTip="Add Email Template" Width="<%$appSettings:TextBoxWidth %>"
                                            MaxLength="25"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="requireRelationName" runat="server" ControlToValidate="txtEmailTemplateDesc"
                                            ValidationGroup="ReqRelationName" Display="Dynamic" ErrorMessage="<br />Enter Email Template"
                    ...
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="acbEmailTemplate" />
                    </Triggers>
                </asp:UpdatePanel>
            </td>
        </tr>
                    ...
                    <ContentTemplate>
                        <asp:Panel ID="pnlGrid" runat="server">
                            <table width="100%" cellpadding="0" border="0">
                                <tr>
                                    <td>
                                        <telerik:RadGrid ID="radgrdEmailTemplate" runat="server" OnPreRender="radgrdEmailTemplate_PreRender"
                                            OnItemDataBound="radgrdEmailTemplate_ItemDataBound" OnNeedDataSource="radgrdEmailTemplate_NeedDataSource"
                                            ...
                                            <MasterTableView AutoGenerateColumns="False" EditMode="InPlace" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridTemplateColumn HeaderText="Id" UniqueName="TEMPLATE_ID" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblgrdRelationIdItem" runat="server" Text='<%# Bind("TEMPLATE_ID") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <EditItemTemplate>
                                                            <asp:Label ID="lblgrdRelationIdEdit" runat="server" Text='<%# Bind("TEMPLATE_ID") %>'></asp:Label>
                                                        </EditItemTemplate>
                                                    </telerik:GridTemplateColumn>
                                                    <telerik:GridTemplateColumn HeaderText="Email Template Name" UniqueName="TEMPLATE_TYPE"
                                                        SortExpression="TEMPLATE_TYPE">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblGrd" runat="server" Text='<%# Bind("TEMPLATE_TYPE") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtgrdRelationDesc" runat="server" Text='<%# Bind("TEMPLATE_TYPE") %>'></asp:TextBox>
                                                            <span class="error">*</span>
