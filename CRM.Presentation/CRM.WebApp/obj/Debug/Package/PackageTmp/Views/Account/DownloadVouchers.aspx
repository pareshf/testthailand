<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master"
    AutoEventWireup="true" CodeBehind="DownloadVouchers.aspx.cs" Inherits="CRM.WebApp.Views.Account.DownloadVouchers" %>
        ...
        <asp:UpdatePanel ID="update_voucher" runat="server" Visible="true" UpdateMode="Conditional"
            ...
            <ContentTemplate>
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="LBL" runat="server" Text="Quotation Reference No."></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="GV_Result" runat="server" AutoGenerateColumns="False" SkinID="sknSubGrid"
                                AllowPaging="true" OnPageIndexChanging="GV_Result_PageIndexChanging" PageSize="10"
                                ...
                                <Columns>
                                    ...
                                    <asp:ButtonField ButtonType="Button" CommandName="Download" Text="Download PDF" />
