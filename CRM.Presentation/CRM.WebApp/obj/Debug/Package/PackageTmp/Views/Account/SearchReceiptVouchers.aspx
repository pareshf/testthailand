                ...
                <asp:Panel ID="pnlMainHead" runat="server" Style="display: none">
                    <table>
                          <tr>
                            ...
                            <td>
                               <telerik:RadComboBox ID="drpAgent" runat="server" Width="250px" 
                    ShowDropDownOnTextboxClick="true" AllowCustomText="false"  AutoPostBack="true" OnSelectedIndexChanged="drpAgent_SelectedIndexChanged">
                </telerik:RadComboBox>
                            </td>
                        </tr>
                        ...
                        <td>
                         <telerik:RadComboBox ID="drp_invoice_no_new" runat="server" Width="250px" 
                    ShowDropDownOnTextboxClick="true" AllowCustomText="false" >
                </telerik:RadComboBox>
                        </td>
                        </tr>
                        <tr>
