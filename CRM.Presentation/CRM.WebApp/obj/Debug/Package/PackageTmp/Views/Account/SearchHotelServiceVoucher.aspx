<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master"
    AutoEventWireup="true" CodeBehind="SearchHotelServiceVoucher.aspx.cs" Inherits="CRM.WebApp.Views.Account.SearchHotelServiceVoucher" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
 ...
 <script language="javascript" type="text/javascript">
    ...
    <div>
        <asp:Label runat="server" Text="Hotel Service Voucher" ID="headlbl" Width="400px"
                ...
                <asp:Panel ID="pnlMainHead" runat="server" Style="display: none">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="drp_city" runat="server" Width="255px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtSupplier" runat="server" Width="250px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td width="180px">
                        ...
                        <td>
                            <asp:GridView ID="GV_Result" runat="server" OnSelectedIndexChanging="GV_Result_SelectedIndexChanging"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="HOTEL_VOUCHER_ID" HeaderText="Voucher Id" />
                                    ...
                                    <asp:BoundField DataField="NO_OF_ROOMS" HeaderText="No of Rooms" />
                                    <asp:BoundField DataField="NO_OF_NIGHTS" HeaderText="No of Nights" />
                                    <asp:BoundField DataField="NO_OF_SINGLE_ROOMS" HeaderText="No of Single Room" />
                                    <asp:BoundField DataField="NO_OF_DOUBLE_ROOMS" HeaderText="No of Double Room" />
                                    <asp:BoundField DataField="NO_OF_TRIPAL_ROOMS" HeaderText="No of Tripple Room" />
                                </Columns>
