<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="PaymentVoucherApprovedLast6Months.aspx.cs" Inherits="CRM.WebApp.Views.Account.SearchPages.PaymentVoucherApprovedLast6Months" %>
...
<style>
 ...
 <div>
        <asp:Label runat="server" Text="Payment Vouchers Approved Last 6 Months" ID="headlbl" Width="400px" Font-Bold="true"
            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="pnlMainHead" runat="server" Style="display: none">
                    <table>
                        <tr>
                            <td width="180px">
                                <asp:Label ID="Label1" runat="server" Text="Purchase Voucher No." CssClass="lblstyle"></asp:Label>
                            </td>
                            <td>
                        ...
                        <td>
                            <asp:GridView ID="GV_Result" runat="server" OnSelectedIndexChanging="GV_Result_SelectedIndexChanging"
                                ...
                                <Columns>
                                   ...
                                   <%--<asp:BoundField DataField="AGAINST_SALES_INVOICE" HeaderText="Against Sales Invoice" />--%>
