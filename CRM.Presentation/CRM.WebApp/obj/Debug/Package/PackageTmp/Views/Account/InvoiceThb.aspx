<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="InvoiceThb.aspx.cs" Inherits="CRM.WebApp.Views.Account.InvoiceThb" %>
                            ...
                            <table style="border-collapse: collapse; border-color: #E6E6E6 #E6E6E6 #CCCCCC" cellspacing="5"
                              ...
                              <%--  <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtInvoiceNo" runat="server" Width="160px" AutoPostBack="True" 
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="lblPeriodStayFrom" runat="server" Text="Period Stay From" CssClass="lblstyle"></asp:Label> &nbsp;<span
                                            class="error">*</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       <%-- <asp:TextBox ID="txtPeriodStayTo" runat="server" Width="160px" onclick="showPopup(this, event);"
                                            ...
                                            <asp:TextBox ID="txtPeriodStayTo" runat="server" Width="160px" OnTextChanged = "txtPeriodStayTo_TextChanged" AutoPostBack="true"></asp:TextBox>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="NoOfNights" runat="server" Text="No Of Nights" CssClass="lblstyle"></asp:Label> &nbsp;<span
                                            class="error">*</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtExRate" runat="server" Width="200" OnTextChanged="txtExRate_TextChanged" AutoPostBack="true"></asp:TextBox>
                               ...
                               <%-- <tr  id="Tr1" runat="server" >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="btnSendInvoice" runat="server" Text="Send Invoice To Agent" Visible="false" OnClick="btnSendInvoice_Click" />
                                    </td>
                        ...
                        <td width="60%" valign="top">
                            <table style="border-collapse: collapse; border-color: #E6E6E6 #E6E6E6 #CCCCCC" cellspacing="5"
                                ...
                                <tr id="row1" runat="server">
                                    ...
                                    <td>
                                        <asp:TextBox ID="row1_txt_debit" runat="server" Width="100px" AutoPostBack="true" OnTextChanged="row1_textchanged"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                ...
                                <tr id="row2" runat="server" style="display: none">
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <asp:TextBox ID="TextBox3" runat="server" Width="100px" AutoPostBack="true" OnTextChanged="row2_textchanged"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                ...
                                <tr id="row3" runat="server" style="display: none">
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBox5" runat="server" Width="100px" AutoPostBack="true" OnTextChanged="row3_textchanged"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                ...
                                <tr id="row4" runat="server" style="display: none">
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBox7" runat="server" Width="100px" AutoPostBack="true" OnTextChanged="row4_textchanged"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                ...
                                <tr id="row5" runat="server" style="display: none">
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBox9" runat="server" Width="100px" AutoPostBack="true" OnTextChanged="row5_textchanged"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                ...
                                <tr id="row6" runat="server" style="display: none">
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBox11" runat="server" Width="100px" AutoPostBack="true" OnTextChanged="row6_textchanged"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                ...
                                <tr id="row7" runat="server" style="display: none">
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <asp:TextBox ID="TextBox13" runat="server" Width="100px" AutoPostBack="true" OnTextChanged="row7_textchanged"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                ...
                                <tr id="row8" runat="server" style="display: none">
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBox15" runat="server" Width="100px" AutoPostBack="true" OnTextChanged="row8_textchanged"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                ...
                                <tr id="row9" runat="server" style="display: none">
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <asp:TextBox ID="TextBox16" runat="server" Width="100px" AutoPostBack="true" OnTextChanged="row9_textchanged"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                ...
                                <tr id="row10" runat="server" style="display: none">
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <asp:TextBox ID="TextBox19" runat="server" Width="100px" AutoPostBack="true" OnTextChanged="row10_textchanged"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                ...
                                <tr id="row11" runat="server" style="display: none">
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <asp:TextBox ID="TextBox46" runat="server" Width="100px" AutoPostBack="true" OnTextChanged="row11_textchanged"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                ...
                                <tr id="row12" runat="server" style="display: none">
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <asp:TextBox ID="TextBox50" runat="server" Width="100px" AutoPostBack="true" OnTextChanged="row12_textchanged"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                ...
                                <tr id="row13" runat="server" style="display: none">
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <asp:TextBox ID="TextBox54" runat="server" Width="100px" AutoPostBack="true" OnTextChanged="row13_textchanged"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                ...
                                <tr id="row14" runat="server" style="display: none">
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <asp:TextBox ID="TextBox58" runat="server" Width="100px" AutoPostBack="true" OnTextChanged="row14_textchanged"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                ...
                                <tr id="row15" runat="server" style="display: none">
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <asp:TextBox ID="TextBox62" runat="server" Width="100px" AutoPostBack="true" OnTextChanged="row15_textchanged"></asp:TextBox>
                                    </td>
                                    <td align="left">
