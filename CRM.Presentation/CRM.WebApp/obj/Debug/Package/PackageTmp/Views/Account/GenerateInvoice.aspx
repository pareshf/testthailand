<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master"
    AutoEventWireup="true" CodeBehind="GenerateInvoice.aspx.cs" Inherits="CRM.WebApp.Views.Account.GenerateInvoice" %>
                    ...
                    <tr>
                        <td width="40%">
                            <table style="border-collapse: collapse; border-color: #E6E6E6 #E6E6E6 #CCCCCC" cellspacing="5"
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="lblquote" runat="server" Text="Quotation Refrence No" CssClass="lblstyle"
                                ...
                                <tr id="Tr1" runat="server">
                                    ...
                                    <td>
                                        <%--Here bind Database Field in text--%>
                                        <asp:TextBox runat="server" Text="" ID="txtDiscount" align="left" Width="80px" OnTextChanged="txtDiscount_TextChanged"
                                            AutoPostBack="true"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox ID="txtBook_ref_no" runat="server" CssClass="textboxstyle" Width="160px"></asp:TextBox><asp:RequiredFieldValidator
                                            ID="RequiredFieldValidator2" runat="server" ErrorMessage="Booking Refernce No Required "
                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="btnSave" runat="server" Text="Save" style="padding:0px" ValidationGroup="Required" OnClick="btnSave_Click" />
    <asp:Button ID="btnclose1" runat="server" Text="Close-1" style="padding:0px" ValidationGroup="Required" Visible="false" OnClick="btnclose1_Click" OnClientClick="javascript:return confirm('After clicking on close-1 you cannot edit this invoice,are you sure want to proceed?');"/>
                        ...
                        <td width="60%" valign="top">
                            <table>
                                <tr>
                                    <td>
                                        <asp:GridView ID="GridDetails" runat="server" AutoGenerateColumns="false" Width="100%"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField ControlStyle-Width="100px">
                                                    <HeaderTemplate>
                                                        <asp:Label ID="lblGridAmoutPerPerson" runat="server" Text="Amount Per Person[USD]"
