<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="ContraVoucherApproved.aspx.cs" Inherits="CRM.WebApp.Views.Account.SearchPages.ContraVoucherApproved" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
     ...
     <div>
        <asp:Label runat="server" Text="Contra Voucher Approved" ID="headlbl" Width="400px" Font-Bold="true"
