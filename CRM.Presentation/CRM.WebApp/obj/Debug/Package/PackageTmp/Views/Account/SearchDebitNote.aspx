<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master"
    AutoEventWireup="true" CodeBehind="SearchDebitNote.aspx.cs" Inherits="CRM.WebApp.Views.Account.SearchDebitNote" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
 ...
 <script language="javascript" type="text/javascript">
    ...
    <div>
        <asp:Label runat="server" Text="Search Debit Note" ID="headlbl" Width="400px" Font-Bold="true"
