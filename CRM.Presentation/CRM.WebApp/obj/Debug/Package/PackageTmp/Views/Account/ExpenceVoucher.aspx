<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master"
    AutoEventWireup="true" CodeBehind="ExpenceVoucher.aspx.cs" Inherits="CRM.WebApp.Views.Account.ExpenceVoucher" %>
 ...
 <script language="javascript" type="text/javascript">
    ...
    <div>
        <asp:UpdatePanel ID="update_voucher" runat="server" Visible="true" UpdateMode="Conditional"
            ...
            <ContentTemplate>
                <asp:Label ID="Label63" runat="server" Text="Expence Voucher" class="pageTitle" Width="300px"
                ...
                <table width="800px" id="AccountsVoucher1" runat="server" border="1" style="border-collapse: collapse;
                    ...
                    <tr style="background-color: #f3f3f3">
                        ...
                        <td>
                            <asp:DropDownList ID="drpvoucher_type" runat="server" Width="155px" AutoPostBack="true" Enabled="false">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr id="Tr0" style="background-color: #f3f3f3" runat="server">
                        <td>
                            <asp:Label ID="lbl_expdate" runat="server" Text="Date" CssClass="headlabel">
                            </asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txt_expdate" runat="server" Width="155px"></asp:TextBox>
                            <ajax:calendarextender id="CalendarExtender1" runat="server" targetcontrolid="txt_expdate"
                                    format="dd/MM/yyyy" popupbuttonid="Image1" />
                        </td>
                    </tr>
                    <tr id="Tr1" style="background-color: #f3f3f3" runat="server">
                        <td>
                            <asp:Label ID="Label2" runat="server" Text="Against Sales Invoice" CssClass="headlabel">
                            </asp:Label>
                        </td>
                        <td>
                    ...
                    <tr id="Trinvoice" style="background-color: #f3f3f3" runat="server">
                        <td>
                            <asp:Label ID="lbl_expinvoice" runat="server" Text="Invoice No" CssClass="headlabel">
                            </asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txt_expinvoice" runat="server" Width="155px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr id="Tr2" style="background-color: #f3f3f3" runat="server">
                        ...
                        <td>
                            <asp:TextBox ID="txtgl_date" runat="server" Width="155px"></asp:TextBox>
                             <ajax:calendarextender id="CalendarExtenderPattya1" runat="server" targetcontrolid="txtgl_date"
                                    format="dd/MM/yyyy" popupbuttonid="Image1" />
                        </td>
                    </tr>

                     <tr id="trVoucherNo" style="background-color: #f3f3f3" runat="server" visible="false">
                        <td>
                            <asp:Label ID="Label5" runat="server" Text="Voucher No" CssClass="headlabel">
                            </asp:Label>
                        </td>
                        <td>
