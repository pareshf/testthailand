<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="PurchaseVoucherApprovedLast6Months.aspx.cs" Inherits="CRM.WebApp.Views.Account.PurchaseVoucherApprovedLast6Months" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
 ...
 <script language="javascript" type="text/javascript">
     ...
     <div>
        <asp:Label runat="server" Text="Purchase Voucher Approved Last 6 Months" ID="headlbl" Width="400px" Font-Bold="true"
            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="pnlMainHead" runat="server" Style="display: none">
                    <table>
                        <tr>
                            <td width="180px">
                                <asp:Label ID="Label1" runat="server" Text="Supplier Invoice No." CssClass="lblstyle"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td width="180px">
                                <asp:Label ID="Label5" runat="server" Text="Sales Invoice No." CssClass="lblstyle"></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="drp_sales_invoice" runat="server" Width="255px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
