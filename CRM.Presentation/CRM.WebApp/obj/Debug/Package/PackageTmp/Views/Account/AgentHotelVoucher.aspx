<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="AgentHotelVoucher.aspx.cs" Inherits="CRM.WebApp.Views.Account.AgentHotelVoucher" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
 ...
 <script language="javascript" type="text/javascript">
     ...
     <div>
        <asp:Label runat="server" Text="Agent Hotel Voucher" ID="headlbl" Width="400px" Font-Bold="true"
