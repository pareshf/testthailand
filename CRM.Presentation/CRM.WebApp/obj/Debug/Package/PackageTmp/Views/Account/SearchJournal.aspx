<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master"
    AutoEventWireup="true" CodeBehind="SearchJournal.aspx.cs" Inherits="CRM.WebApp.Views.Account.SearchJournal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
 ...
 <script language="javascript" type="text/javascript">
    ...
    <div>
        <asp:Label runat="server" Text="Search Journal Voucher" ID="headlbl" Width="400px"
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <ajax:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="TextBox2"
