<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="GitSiteSeeingRate.aspx.cs" Inherits="CRM.WebApp.Views.GIT.GitSiteSeeingRate" %>
...
<asp:Label ID="Label55" runat="server" Text="Site Seeing Rates" class="pageTitle"
            Width="200px" Font-Bold="true" Font-Size="Large"></asp:Label>
        <br />
        <br />
        <asp:Label runat="server" ID="lblPriceHeader" Text="Price of " CssClass="pageTitle"></asp:Label>
        <asp:Label runat="server" ID="lblSiteName" Text="" CssClass="pageTitle"></asp:Label>
        <br />
        <br />
        ...
        <asp:TemplateField ControlStyle-Width="100px">
            <HeaderTemplate><asp:Label runat="server" ID="lblNetRate" Text="Adult Rate Per Pax" CssClass="lblstyleGIT"></asp:Label></HeaderTemplate>
            <ItemTemplate><asp:TextBox runat="server" ID = "txtAdultRate" Text='<%# Bind("ADULT_RATE_PER_PERSON") %>'></asp:TextBox></ItemTemplate>
        </asp:TemplateField>


        <asp:TemplateField ControlStyle-Width="100px">
            <HeaderTemplate><asp:Label runat="server" ID="lblTotalRate" Text="Child Seeing Rate" CssClass="lblstyleGIT"></asp:Label></HeaderTemplate>
        ...
        <asp:TemplateField Visible="false">
            ...
            <ItemTemplate><asp:Label runat="server" ID="lblCartID" Text='<%# Bind("GIT_SIGHT_CART_ID") %>' CssClass="lblstyleGIT"></asp:Label></ItemTemplate>
        </asp:TemplateField>
