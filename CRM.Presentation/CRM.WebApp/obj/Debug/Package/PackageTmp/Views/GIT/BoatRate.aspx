<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="BoatRate.aspx.cs" Inherits="CRM.WebApp.Views.GIT.BoatRate" %>
...
<div>
      <asp:Label ID="Label55" runat="server" Text="Boat Rates" class="pageTitle"
            Width="200px" Font-Bold="true" Font-Size="Large"></asp:Label>
            <br />
            <br />
            <asp:Label runat="server" ID="lblPriceHeader" Text="Price of Boat" CssClass="pageTitle"></asp:Label>
    ...
    <ContentTemplate>
        <asp:GridView ID="gridBoat" runat="server" AllowPaging="false" AutoGenerateColumns="false" CssClass="pageTitle" Width="500px" SkinID="sknSubGrid">
            <Columns>
            ...
            <ItemTemplate><asp:Label runat="server" ID="lblCartID" Text='<%# Bind("GIT_BOAT_CART_ID") %>' CssClass="lblstyleGIT"></asp:Label></ItemTemplate>
        </asp:TemplateField>
