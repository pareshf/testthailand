<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="GitGalaDinnerRate.aspx.cs" Inherits="CRM.WebApp.Views.GIT.GitGalaDinnerRate" %>
...
<asp:Label ID="Label55" runat="server" Text="Gala Dinner Rates" class="pageTitle"
            Width="200px" Font-Bold="true" Font-Size="Large"></asp:Label>
        <br />
        <br />
        <asp:Label runat="server" ID="lblPriceHeader" Text="Price of Gala Dinner" CssClass="pageTitle"></asp:Label>
        <asp:Label runat="server" ID="lblGalaDinnerName" Text="" CssClass="pageTitle"></asp:Label>
        <br />
        <br />
        ...
        <asp:TemplateField ControlStyle-Width="100px">
         ...
         <asp:TemplateField Visible="false">
            ...
            <ItemTemplate><asp:Label runat="server" ID="lblCartID" Text='<%# Bind("GIT_GALA_DINNER_CART_ID") %>' CssClass="lblstyleGIT"></asp:Label></ItemTemplate>
        </asp:TemplateField>
