<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="OutStandinStatementRpt.aspx.cs" Inherits="CRM.WebApp.Views.MIS.OutStandinStatementRpt" %>
...
<style>
 ...
 <div class="pageTitle">
        <asp:Literal ID="lblPageAddress" runat="server" Text="OutstandingStatement Reports"></asp:Literal>
    </div>
    <div>
    ...
    <table>
    <tr id="agentdrp" runat="server" style="display:none">
            <td>
                <asp:Label ID="Label2" runat="server" Text="Agent Company Name"></asp:Label>
            </td>
            <td>
                 <asp:DropDownList ID="drpAgentType" runat="server" Width="200px">
                            </asp:DropDownList>
            </td>
        </tr>
        <tr>
                ...
                <%--<asp:TextBox ID="txtfromdate" runat="server" Width="<%$appSettings:TextBoxWidth%>"
                    ...
                    <asp:DropDownList ID="DropDownList1" runat="server" >
                     <asp:ListItem></asp:ListItem>
                                        <asp:ListItem>01/03/2012</asp:ListItem>
                                                    <asp:ListItem>01/04/2012</asp:ListItem>
                                                     <asp:ListItem>01/05/2012</asp:ListItem>
                                                    <asp:ListItem>01/06/2012</asp:ListItem>
                                                    <asp:ListItem>01/07/2012</asp:ListItem>
                                                    <asp:ListItem>01/08/2012</asp:ListItem>
                            </asp:DropDownList>
