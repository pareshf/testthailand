<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="ProdcutProfitLoss.aspx.cs" Inherits="CRM.WebApp.Views.MIS.ProdcutProfitLoss" %>
...
<style>
    ...
    <asp:Label runat="server" Text="Profit Loss Reports" ID="headlbl" Width="200px" Font-Bold="true"
    ...
    <div id="paymentmode" class="pageTitle">
        <table width="475px" cellspacing="5" cellpadding="5">
            <tr>
                <td width="220px">
                    <asp:Label runat="server" Text="Product Code" ID="payment_mode" CssClass="lblstyle"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td width="220px">
                    <asp:Label runat="server" Text="From GL Date" ID="Label1" CssClass="lblstyle"></asp:Label>
                </td>
                <td>
     ...
     <ajax:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender21" runat="server" TargetControlID="txt_fromdate"
            ...
            <tr>
                <td width="220px">
                    <asp:Label runat="server" Text="To GL Date" ID="Label2" CssClass="lblstyle"></asp:Label>
                </td>
                <td>
