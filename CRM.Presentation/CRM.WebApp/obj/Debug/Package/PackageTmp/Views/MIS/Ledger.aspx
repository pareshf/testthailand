<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master"
    AutoEventWireup="true" CodeBehind="Ledger.aspx.cs" Inherits="CRM.WebApp.Views.MIS.Ledger" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
    ...
    <table>
        <tr>
            ...
            <td>
                <telerik:RadComboBox ID="drpAgentType" runat="server" MarkFirstMatch="True" AutoCompleteSeparator=";"
                    Width="269px" ShowDropDownOnTextboxClick="true" AllowCustomText="false">
                    <Items>
                    </Items>
                </telerik:RadComboBox>
