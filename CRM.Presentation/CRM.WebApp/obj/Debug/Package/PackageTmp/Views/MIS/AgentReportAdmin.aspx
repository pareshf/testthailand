<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master"
    AutoEventWireup="true" CodeBehind="AgentReportAdmin.aspx.cs" Inherits="CRM.WebApp.Views.MIS.AgentReportAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
    ...
    <table>
        <tr>
            <td>
                <asp:Label ID="Label2" runat="server" Text="Company Name"></asp:Label>&nbsp;<span
                    class="error">*</span>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txttraveltodate" runat="server" Width="<%$appSettings:TextBoxWidth%>" Visible="true"
                    onclick="showPopup(this, event);" onfocus="showPopup(this, event);" onkeydown="parseDate(this, event);"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="lblNotSettled" runat="server" Text="Show Only Not Settled"></asp:Label>
            </td>
            <td>
                <asp:CheckBox ID="chknotsettled" runat="server" />
            </td>
        </tr>
        <tr>
            <td>
