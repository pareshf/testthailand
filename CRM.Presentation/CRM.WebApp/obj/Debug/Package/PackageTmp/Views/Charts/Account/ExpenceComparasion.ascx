<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ExpenceComparasion.ascx.cs" Inherits="CRM.WebApp.Views.Charts.Account.ExpenceComparasion" %>
				...
				<td>
					<asp:chart id="Chart1" runat="server" Height="250px" Width="250px" 
						...
						<chartareas>
							...
							<axisy linecolor="64, 64, 64, 64" Title="Expense Amount (THB)">
