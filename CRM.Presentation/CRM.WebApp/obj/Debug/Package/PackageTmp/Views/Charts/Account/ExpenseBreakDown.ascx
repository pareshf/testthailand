<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ExpenseBreakDown.ascx.cs" Inherits="CRM.WebApp.Views.Charts.Account.ExpenseBreakDown" %>
				...
				<tr>
					<td>
						<asp:CHART id="Chart1" runat="server" Palette="None"
                            Height="250px" Width="350px" BorderDashStyle="Solid" 
                            ...
                            PaletteCustomColors="80, 180, 50; 5, 141, 199; LightPink; 147, 54, 168; SkyBlue; 255, 128, 128; 237, 86, 27; 255, 178, 13; 122, 126, 129; ">
							<legends>
