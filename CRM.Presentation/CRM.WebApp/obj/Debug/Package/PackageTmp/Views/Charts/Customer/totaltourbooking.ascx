<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="totaltourbooking.ascx.cs" Inherits="CRM.WebApp.Views.Charts.Customer.totaltourbooking" %>
				...
				<tr>
					<td>
						<asp:CHART id="Chart1" runat="server" Palette="None"
                            ...
                            PaletteCustomColors="80, 180, 50; 5, 141, 199; 255, 178, 13; 147, 54, 168; 247, 221, 14; 237, 86, 27; 122, 126, 129; ">
							<legends>
