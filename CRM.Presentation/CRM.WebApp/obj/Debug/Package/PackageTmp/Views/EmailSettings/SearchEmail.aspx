<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="SearchEmail.aspx.cs" Inherits="CRM.WebApp.Views.EmailSettings.SearchEmail" %>
...
<style>
     ...
     <div>
        <asp:Label runat="server" Text="Search Email" ID="headlbl" Width="400px" Font-Bold="true"
            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="pnlMainHead" runat="server" Style="display: none">
                    <table>
                        <tr>
                            <td width="180px">
                                <asp:Label ID="Label1" runat="server" Text="Event Name" CssClass="lblstyle"></asp:Label>
                            </td>
                            <td>
                        ...
                        <td>
                            <asp:GridView ID="GV_Result" runat="server" OnSelectedIndexChanging="GV_Result_SelectedIndexChanging"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="FROM_ROLE_NAME" HeaderText="From type Id" />
                                    <asp:BoundField DataField="TO_ROLE_NAME" HeaderText="To type Id" />
                                    <asp:BoundField DataField="EVENT_NAME" HeaderText="Event Name" />
                                    <asp:BoundField DataField="EMAIL_TEMPLATE_MASTER_ID" HeaderText="Email Template id" />
