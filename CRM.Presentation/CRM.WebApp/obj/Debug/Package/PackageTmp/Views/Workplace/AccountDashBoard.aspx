<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="AccountDashBoard.aspx.cs" Inherits="CRM.WebApp.Views.Workplace.AccountDashBoard" %>
                       ...
                       <clientevents ondateclick="Calendarfrom_OnDateClick"></ClientEvents>
                         ...
                         <clientevents ondateclick="Calendarto_OnDateClick"></ClientEvents>
                                ...
                                <asp:TextBox ID="txtfrom" runat="server"></asp:TextBox><br />
                                        ...
                                        <br />
                                        <br />
                                        <span>Employee :</span><asp:DropDownList ID="ddlEmployee" runat="server" Width="160px">
                                        </asp:DropDownList>
