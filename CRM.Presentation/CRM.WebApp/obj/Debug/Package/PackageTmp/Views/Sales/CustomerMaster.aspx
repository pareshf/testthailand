<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master"
    AutoEventWireup="true" CodeBehind="CustomerMaster.aspx.cs" Inherits="CRM.WebApp.Views.Sales.CustomerMaster" %>
        ...
        <script type="text/javascript">
                ...
                if (!ary[2] == 0 && !ary[3] == 0 && !ary[4] == 0 && !ary[15] == 0 && !ary[16] == 0 && !ary[19] == 0 && !ary[7] == 0) {
                    if (!ary[5] == 0 || !ary[11] == 0) {
                        try {
                            ...
                            var q = window.location.search.substring(1);
                            if (q != "") {
                                CRM.WebApp.webservice.CustomerMasterWebService.InsertUpdateCust(ary);
                                CRM.WebApp.webservice.CustomerMasterWebService.GetCustwithID(cust_id, updateCustGrid);
            ...
            function RelationAdded(sender, args) {
                ...
                if (ary[11] != '') {
                    ...
                    alert('Enter Reletion With Customer');
                }
            }
            ...
            <tr>
                <td>
                    <telerik:radgrid id="radgridcustomermaster" runat="server" allowpaging="true" allowmultirowselection="false"
                        ...
                        allowautomaticdeletes="True" allowautomaticinserts="True" width="3550">
                ...
                <telerik:GridTemplateColumn SortExpression="CUST_ID" DataField="CUST_ID" HeaderText="Customer ID" Visible="false">
                 ...
                 <telerik:GridTemplateColumn SortExpression="CUST_UNQ_ID" DataField="CUST_UNQ_ID" HeaderText="Unique Id" Visible="true">
                  <HeaderStyle HorizontalAlign="Left" Width="80px"/>                       
                    ...
                    <telerik:GridTemplateColumn SortExpression="REMARKS" DataField="REMARKS" HeaderText="Remarks" Visible="false">
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn SortExpression="CUST_REL_PHONE" DataField="CUST_REL_PHONE" HeaderText="Telephone No. *">
                     ...
                     <telerik:GridTemplateColumn SortExpression="BRANCH" DataField="BRANCH" HeaderText="Branch *" Visible+"false">
                     <HeaderStyle HorizontalAlign="Left" ForeColor = "Red"/>
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn SortExpression="CUST_REL_ID" DataField="CUST_REL_ID" HeaderText="Relation Id">
                        <ItemTemplate>
                            <asp:TextBox ID="CUST_REL_ID" runat="server" CssClass="radinput"></asp:TextBox>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn SortExpression="CUST_REL_SRNO" DataField="CUST_REL_SRNO" HeaderText="Relation Sr No.">
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn SortExpression="CUST_BIRTH_DATE" DataField="CUST_BIRTH_DATE" HeaderText="Birth Date" Visible="false" >
                        <HeaderStyle HorizontalAlign="Center" Width="80px" />
                        <ItemTemplate>
            ...
            <MasterTableView ClientDataKeyNames="CUST_ID" AllowMultiColumnSorting="true" EditMode="InPlace">
              ...
              <ClientSettings ReorderColumnsOnClient="true" AllowDragToGroup="true"
                AllowColumnsReorder="True">
                 <KeyboardNavigationSettings AllowActiveRowCycle="true"/>
            <Resizing AllowColumnResize="true" ResizeGridOnColumnResize="true" />
                <ClientEvents OnCommand="radgridcontdetmaster_Command" OnRowSelected="radgridcontdetmaster_RowSelected" OnRowDblClick="ContactAddeddouble"/>
                <Selecting AllowRowSelect="true"/>
            </ClientSettings>
        </telerik:radgrid>
            ...
            <MasterTableView ClientDataKeyNames="CUST_ID" AllowMultiColumnSorting="true" EditMode="InPlace">
              ...
              <ClientSettings ReorderColumnsOnClient="true" AllowDragToGroup="true"
                AllowColumnsReorder="True">
                 <KeyboardNavigationSettings AllowActiveRowCycle="true"/>
            <Resizing AllowColumnResize="true" ResizeGridOnColumnResize="true" />
                <ClientEvents OnCommand="radgridcustomerrelation_Command" OnRowSelected="radgridcustomerrelation_RowSelected" OnRowDblClick="RelationAddeddouble"/>
                <Selecting AllowRowSelect="true"/>
            </ClientSettings>
        </telerik:radgrid>
