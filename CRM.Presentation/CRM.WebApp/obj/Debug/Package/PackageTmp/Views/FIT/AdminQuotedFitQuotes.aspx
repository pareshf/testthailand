<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="AdminQuotedFitQuotes.aspx.cs" Inherits="CRM.WebApp.Views.FIT.AdminQuotedFitQuotes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
    ...
    <div>
        <asp:Label runat="server" Text="FIT - Admin Quoted Packages" ID="headlbl" Width="600px" Font-Bold="true"
            Font-Size="Large" class="pageTitle"></asp:Label>
        <br />
        <br />
        <asp:UpdatePanel ID="Updateconfirm" runat="server" UpdateMode="Conditional" 
            class="pageTitle">
            <ContentTemplate>
                <table>
                    <tr>
                ...
                <table>
                    <tr>
                        <td>
                            <asp:GridView ID="GV_Result" runat="server"  OnRowCommand="GV_Result_RowCommand"
                                ...
                                <Columns>
                                   ...
                                   <asp:ButtonField ButtonType="Button" CommandName="Disapproved" Text="Delete" />
                                    <asp:BoundField DataField="QUOTE_ID" HeaderText="Quotation Ref.No." />
                                    ...
                                    <%--<asp:BoundField DataField="CUST_NAME" HeaderText="User Name" />
