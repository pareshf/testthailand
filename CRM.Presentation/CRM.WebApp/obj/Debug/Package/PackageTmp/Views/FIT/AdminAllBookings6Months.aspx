<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="AdminAllBookings6Months.aspx.cs" Inherits="CRM.WebApp.Views.FIT.AdminAllBookings6Months" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
 ...
 <script language="javascript" type="text/javascript">
     ...
     <div>
        <asp:Label runat="server" Text="FIT - All Bookings in Last 6 Months" ID="headlbl" Width="600px" Font-Bold="true"
