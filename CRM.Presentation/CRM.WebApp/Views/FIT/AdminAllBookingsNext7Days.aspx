<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="AdminAllBookingsNext7Days.aspx.cs" Inherits="CRM.WebApp.Views.FIT.AdminAllBookingsNext7Days" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
    ...
    <script language="javascript" type="text/javascript">
     ...
     <div>
        <asp:Label runat="server" Text="FIT - All Bookings To be Reconfirmed in Next 7 Days" ID="headlbl" Width="700px" Font-Bold="true"
