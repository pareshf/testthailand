...
namespace CRM.WebApp.Views.FIT
{
    public partial class MyBooking : System.Web.UI.Page
    {
        ...
        protected void GV_Result_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            string quoteid = GV_Result.Rows[newindex].Cells[0].Text;
        ...
        protected void searchnow_onclick(object sender, EventArgs e)
        {
            ...
            DataSet ds = objmybooking.fetchallDatasearch("FETCH_TOUR_DATA_FOR_LOGIN_USER_BOOKED_SEARCH", USERID, txtrefrence.Text, TextBox5.Text, TextBox1.Text, DropDownList2.Text, TextBox2.Text, TextBox3.Text);
