<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master"
    AutoEventWireup="true" CodeBehind="AdminFITPayment.aspx.cs" Inherits="CRM.WebApp.Views.FIT.AdminFITPayment" %>
    ...
    <div id="paymentmode" class="pageTitle">
        <table width="475px" cellspacing="5" cellpadding="5">
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="drpPayment" runat="server" Width="233px" OnSelectedIndexChanged="drpPayment_SelectedIndexChanged"
                        AutoPostBack="true">
                    </asp:DropDownList>
                </td>
            </tr>
    ...
    <asp:UpdatePanel ID="updatebutton" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
        <ContentTemplate>
            <table id="Table1" runat="server" class="pageTitle">
                <tr>
                    <%--<td>
                    <asp:Button ID="btnpaynow" runat="server" Text="Pay Now" ValidationGroup=/>
                    </td>--%>
                    

                    <td>
                        <asp:Button ID="btnpatnow" runat="server" Text="Pay Now" OnClick="btnpatnow_Click"/>
                        <%--<asp:Button ID="btnpatnow" runat="server" Text="Pay Now" ValidationGroup="Required"
                            OnClick="btnpatnow_Click" />--%>
                    </td>
                    <td>
                        <asp:Button ID="btnpay" runat="server" Text="Pay Now" OnClick="btnpatnow_Click" visible="false"/>
                    </td>
                    <td>
