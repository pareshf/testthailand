...
{
    public partial class AllMyBookings : System.Web.UI.Page
    {
        MyBookingStorprocedure objmybooking = new MyBookingStorprocedure();
        ...
        protected void Page_PreInit(object sender, EventArgs e)
        {
            ...
            DataTable dt = objAuthorizationDal.GetPageRights(Convert.ToInt32(CompId), Convert.ToInt32(DeptId), Convert.ToInt32(RoleId), 223);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet ds = objmybooking.fetchallDataformybooking("FETCH_TOUR_DATA_FOR_LOGIN_USER_BOOKED", usrid);
        ...
        protected void GV_Result_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            //GV_Result.Rows[newindex].Cells[1].Visible = false;
            string usrid = Session["usersid"].ToString();
            DataSet ds = objmybooking.fetchallDataformybooking("FETCH_TOUR_DATA_FOR_LOGIN_USER_BOOKED", usrid);
        ...
        protected void searchnow_onclick(object sender, EventArgs e)
        {
            ...
            DataSet ds = objmybooking.fetchallDatasearch("FETCH_TOUR_DATA_FOR_BOOKED_SEARCH", USERID, txtrefrence.Text, TextBox5.Text, TextBox1.Text, DropDownList2.Text, TextBox2.Text, TextBox3.Text);
