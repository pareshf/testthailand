...
{
    public partial class AdminAllBookings6Months : System.Web.UI.Page
    {
        ...
        protected void Page_PreInit(object sender, EventArgs e)
        {
            ...
            DataTable dt = objAuthorizationDal.GetPageRights(Convert.ToInt32(CompId), Convert.ToInt32(DeptId), Convert.ToInt32(RoleId), 250);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet ds = objfitquote.fetchallData("FETCH_DATA_FOR_ALL_BOOKING_LAST6_MONTHS", usrid);
        ...
        protected void searchnow_onclick(object sender, EventArgs e)
        {
            ...
            DataSet ds = objfitquote.fetchallDatasearch("FETCH_DATA_FOR_ALL_BOOKING_LAST6_MONTHS_SEARCH", USERID, txtrefrence.Text, TextBox5.Text, TextBox1.Text, DropDownList2.Text, TextBox2.Text, TextBox3.Text);
