<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="AgentClosedBooking.aspx.cs" Inherits="CRM.WebApp.Views.FIT.AgentClosedInvoice" %>
...
<div>
        <asp:Label runat="server" Text="Agent Closed Bookings" ID="headlbl" Width="600px" Font-Bold="true"
        ...
        <asp:UpdatePanel ID="Updateconfirm" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false"
            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="pnlMainHead" runat="server" Style="display: none">
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtquotaion" runat="server" Width="250px"></asp:TextBox>
                            </td>
                        </tr>
                        <%--<tr>
                            <td width="180px">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txttour" runat="server" Width="250px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td width="180px">
                ...
                <table width="100%">
                    <tr>
                        <td>
                            <asp:GridView ID="GV_ClosedBooking" runat="server" OnSelectedIndexChanging="GV_Result_SelectedIndexChanging"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="TOUR_SHORT_NAME" HeaderText="Tour Name" />
                                    <asp:BoundField DataField="TOUR_FROM_DATE" HeaderText="From Date" />
                                    <asp:BoundField DataField="TOUR_TO_DATE" HeaderText="To Date" />
                                    <asp:BoundField DataField="ORDER_STATUS_NAME" HeaderText="Status" />
                                    <asp:BoundField DataField="NO_OF_ADULTS" HeaderText="No Adults" />
                                    <asp:BoundField DataField="NO_OF_CWB" HeaderText="No CWB" />
                                    <asp:BoundField DataField="NO_OF_CNB" HeaderText="No CNB" />
