...
{
    public partial class AgentCanceledBooking : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet ds = objfitquote.fetchallData("FETCH_ALL_CANCELED_BOOKING", usrid);
                ...
                DropDownList2.SelectedValue = "Canceled";
        ...
        protected void GV_Result_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Session["editorderstatus"] = GV_Result.Rows[newindex].Cells[5].Text;
        ...
        protected void searchnow_onclick(object sender, EventArgs e)
        {
            ...
            DataSet ds = objfitquote.fetchallDatasearch("FETCH_ALL_BOOKING_CANCELED_SEARCH", USERID, txtrefrence.Text, TextBox5.Text, TextBox1.Text, DropDownList2.Text, TextBox2.Text, TextBox3.Text);
