<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="AgentApprovedCashOnArrival.aspx.cs" Inherits="CRM.WebApp.Views.FIT.AgentApprovedCashOnArrival" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
    ...
    <script language="javascript" type="text/javascript">
     ...
     <div>
        <asp:Label runat="server" Text="Agent Approved Cash On Arrival" ID="headlbl" Width="200px" Font-Bold="true"
