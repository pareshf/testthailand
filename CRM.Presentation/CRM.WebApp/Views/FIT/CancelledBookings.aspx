<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="CancelledBookings.aspx.cs" Inherits="CRM.WebApp.Views.FIT.CancelledBookings" %>
             ...
             <%--   <table>
                ...
                <table>
                    <tr>
                        ...
                        <td><asp:Button runat="server" ID="btnCancel" Text = "Cancel Bookings" OnClick="btnCancel_onclick"/></td>
                    </tr>
                </table>
                           ...
                           <%--     OnSelectedIndexChanging="GV_Result_SelectedIndexChanging"
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:BoundField DataField="TOUR_ID" HeaderText="Tour Id" />
                                     <asp:BoundField DataField="RECONFIRMATION_DATE" HeaderText="Reconfirm Date" />
