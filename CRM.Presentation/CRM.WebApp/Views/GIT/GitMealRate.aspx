<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="GitMealRate.aspx.cs" Inherits="CRM.WebApp.Views.GIT.GitMealRate" %>
...
<asp:Label ID="Label55" runat="server" Text="Meal Rates" class="pageTitle"
            Width="200px" Font-Bold="true" Font-Size="Large"></asp:Label>
        <br />
        <br />
         <br />
        <br />
        <asp:Label runat="server" ID="lblPriceHeader" Text="Price of Resturant :  " CssClass="pageTitle"></asp:Label>
        <asp:Label runat="server" ID="lblResturant" Text="" CssClass="pageTitle"></asp:Label>
        <br />
        <br />
        ...
        <asp:TemplateField Visible="false">
            ...
            <ItemTemplate><asp:Label runat="server" ID="lblCartID" Text='<%# Bind("GIT_RESTAURENT_CART_ID") %>' CssClass="lblstyleGIT"></asp:Label></ItemTemplate>
        </asp:TemplateField>
        </Columns>
