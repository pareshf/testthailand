...
{
    public partial class GuideRate : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                    ...
                    if (Request["TOURID"] != null && !string.IsNullOrEmpty(Request["TOURID"].ToString()))
                    {
                        ...
                        DataSet ds = objEditUpdateGITInformation.GetGuideRate(TourId, GIT_TRANSFER_PACKGE_ID, suppilername);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            foreach (GridViewRow item in gridGuide.Rows)
            {
                ...
                objEditUpdateGITInformation.saveGuideRate(int.Parse(cartID.Text), txtAdultRate.Text, txtChildRate.Text);
