...
{
    public partial class AgentCreditLimitReport : System.Web.UI.Page
    {
        string fromdate = "";
        string todate = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rptViewer1.ServerReport.ReportPath = "/ThailandReport/AgentCreditLimitReport";
            ...
            Response.AddHeader("content-disposition", "attachment; filename = AgentCreditLimitReport." + fileNameExtension);
