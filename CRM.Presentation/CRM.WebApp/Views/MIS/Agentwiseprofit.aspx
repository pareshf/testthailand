<%@ Page Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true"
    CodeBehind="Agentwiseprofit.aspx.cs" Inherits="CRM.WebApp.Views.MIS.Agentwiseprofit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
    ...
    <div class="pageTitle">
        <asp:Literal ID="lblPageAddress" runat="server" Text="Profit Reports"></asp:Literal>
    </div>
    <div>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <telerik:RadComboBox ID="drpinvoiceno" runat="server" Width="269px" ShowDropDownOnTextboxClick="true"
        ...
        <tr>
            <td>
                <asp:Label ID="lblfromdate" runat="server" Text="Invoice From Date" CssClass="lblstyle"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td>
                <asp:Label ID="Label1" runat="server" Text="Invoice To Date" CssClass="lblstyle"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txttravelfromdate" runat="server" Width="<%$appSettings:TextBoxWidth%>"
                    Visible="true" onclick="showPopup(this, event);" onfocus="showPopup(this, event);"
                    onkeydown="parseDate(this, event);"></asp:TextBox>
            </td>
        </tr>
