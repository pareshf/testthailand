...
namespace CRM.WebApp.Views.MIS
{
    public partial class OutstandingReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            userid = Page.Request.QueryString["key2"].ToString();
            ...
            if (userid != "")
            {
                parm[2] = new ReportParameter("USER_ID", userid);
            }
            else
            {
                parm[2] = new ReportParameter("USER_ID"," ");
            }
            ...
            rptViewer1.ServerReport.ReportPath = "/ThailandReport/OutstandingStatementReport";
            ...
            Response.AddHeader("content-disposition", "attachment; filename = OutstandingStatementReport." + fileNameExtension);
