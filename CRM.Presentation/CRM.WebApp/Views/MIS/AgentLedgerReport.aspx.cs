...
{
    public partial class AgentLedgerReport : System.Web.UI.Page
    {
        ...
        protected void btnshow_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Views/MIS/AgentWiseLedgerRpt.aspx?key=" + fromdate + "&key1=" + todate + "&key2=" + supliercompany);
        }
    }
}