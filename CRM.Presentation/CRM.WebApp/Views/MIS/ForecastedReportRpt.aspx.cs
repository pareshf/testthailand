...
{
    public partial class ForecastedReportRpt : System.Web.UI.Page
    {
        string fromdate = "";
        string todate = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (suppliercompanyname != "")
            {
                ...
                parm[0] = new ReportParameter("GL_DESCRIPTION", suppliercompanyname);
            }
            else
            {
            ...
            rptViewer1.ServerReport.ReportPath = "/ThailandReport/ForeCastReport";
