...
{
    public partial class ProfitRepotRpt : System.Web.UI.Page
    {
        string fromdate = "";
        string todate = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (InvoiceType != null)
            {
                ...
                parm[3] = new ReportParameter("INVOICE_TYPE", InvoiceType.ToString());
            }
            else
            {
                parm[3] = new ReportParameter("INVOICE_TYPE", " ");
            }
            ...
            {
                DateTime dt2 = DateTime.ParseExact(travelfromdate.ToString(), "dd/MM/yyyy", null);
                parm[4] = new ReportParameter("TRAVEL_FROM_DATE", dt2.ToString());
            }
            //
            //
            if (traveltodate == "")
            ...
            {
                DateTime dt3 = DateTime.ParseExact(traveltodate.ToString(), "dd/MM/yyyy", null);
                parm[5] = new ReportParameter("TRAVEL_TO_DATE", dt3.ToString());
            }
            ...
            if (InvoiceNumber != "")
            {
                parm[6] = new ReportParameter("INVOICE_NUMBER", InvoiceNumber);
            }
            else
            {
                parm[6] = new ReportParameter("INVOICE_NUMBER", " ");
            }
            ...
            if (InvoiceNumber != "")
            {
                rptViewer1.ServerReport.ReportPath = "/ThailandReport/ProfitReportWithInvoice";
            }
            else
            {
                rptViewer1.ServerReport.ReportPath = "/ThailandReport/ProfitReport";
