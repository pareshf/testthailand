<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="RequestForQuoteGITPackages.aspx.cs" Inherits="CRM.WebApp.Views.GITSearch.RequestForQuoteGITPackages" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
     ...
     <div>
        <asp:Label runat="server" Text="GIT - All Request for Quote Bookings" ID="headlbl" Width="600px" Font-Bold="true"
