<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="QuotedGITPackages.aspx.cs" Inherits="CRM.WebApp.Views.GITSearch.QuotedGITPackages" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
     ...
     <div>
        <asp:Label runat="server" Text="GIT - All Quoted Bookings" ID="headlbl" Width="600px" Font-Bold="true"
