<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BirthdateCustomer.ascx.cs" Inherits="CRM.WebApp.Views.Charts.Customer.BirthdateCustomer" %>
			...
			<tr>
				<td>
					<asp:chart id="Chart1" runat="server" Height="250px" Width="250px" 
                        ...
                        PaletteCustomColors="247, 221, 14">
						<legends>
