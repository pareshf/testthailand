<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RegionwiseBooking.ascx.cs" Inherits="CRM.WebApp.Views.Charts.Customer.RegionwiseBooking" %>
				...
				<tr>
					<td>
						<asp:CHART id="Chart1" runat="server" Palette="None"
                            ...
                            PaletteCustomColors="5, 141, 199; 80, 180, 50; 237, 86, 27; 255, 178, 13; 147, 54, 168; 247, 221, 14; 122, 126, 129; ">
							<legends>
