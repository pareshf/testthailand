...
{
    public partial class PurchaseInvoiceOutstanding : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                DataSet ds2 = objSearchPurchaseInvoice.fetchallDatasearch("SEARCH_PURCHASE_INVOICE_OUTSTANDING", drp_invoice_no.Text, drp_supplier_type.Text, TextBox2.Text, TextBox3.Text, drp_compnay_name.Text);
        ...
        protected void searchnow_onclick(object sender, EventArgs e)
        {
            ...
            DataSet ds = objSearchPurchaseInvoice.fetchallDatasearch("SEARCH_PURCHASE_INVOICE_OUTSTANDING", drp_invoice_no.Text, drp_supplier_type.Text, TextBox2.Text, TextBox3.Text, drp_compnay_name.Text);
