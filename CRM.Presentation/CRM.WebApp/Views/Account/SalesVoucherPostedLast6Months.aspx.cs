...
{
    public partial class SalesVoucherPostedLast6Months : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                DataSet ds2 = objstatus.fetchallDatasearchforMonths("FETCH_ALL_SALES_PURCHASE_DATA_BY_STATUS", drp_invoice_no.Text, drp_voucher_status.Text, drp_voucher_type.Text, ViewState["Duration_From"].ToString(), d1);
        ...
        protected void searchnow_onclick(object sender, EventArgs e)
        {
            ...
            if (txtfromdate.Text != "")
            {
                ...
                DataSet ds = objstatus.fetchallDatasearchforMonths("FETCH_ALL_SALES_PURCHASE_DATA_BY_STATUS", drp_invoice_no.Text, drp_voucher_status.Text, drp_voucher_type.Text, txtfromdate.Text, txttodate.Text);
            ...
            {
                DateTime currentDateWithCurrentTime = System.DateTime.Now;
                DateTime datebefore6Months = currentDateWithCurrentTime.AddMonths(-6);
                string date3 = datebefore6Months.ToString("dd/MM/yyyy");
                ViewState["Duration_From"] = date3;

                DataSet ds = objstatus.fetchallDatasearchforMonths("FETCH_ALL_SALES_PURCHASE_DATA_BY_STATUS", drp_invoice_no.Text, drp_voucher_status.Text, drp_voucher_type.Text, ViewState["Duration_From"].ToString(), txttodate.Text);
                pnlMainHead.Attributes.Add("style", "display:none");
                Button4.Attributes.Add("style", "display:none");
                Button3.Attributes.Add("style", "display");
                GV_Result.DataSource = ds.Tables[0];
        ...
        protected void GV_Result_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            DataSet ds = objstatus.fetchallDatasearchforMonths("FETCH_ALL_SALES_PURCHASE_DATA_BY_STATUS", drp_invoice_no.Text, drp_voucher_status.Text, drp_voucher_type.Text,txttodate.Text, txttodate.Text);
