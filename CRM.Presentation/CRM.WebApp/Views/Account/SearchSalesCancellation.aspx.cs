...
{
    public partial class SearchSalesCancellation : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                DataSet ds0 = objSearchPurchaseCancellation.fetch_voucher_type("FETCH_INVOICE_NO_FOR_SALES_CANCELLATION");
                binddropdownlist(drp_invoice_no, ds0);

                DataSet ds2 = objSearchPurchaseCancellation.fetchallDatasearch("SEARCH_SALES_CANCELLATION", drp_invoice_no.Text, TextBox2.Text, TextBox3.Text);
        ...
        protected void searchnow_onclick(object sender, EventArgs e)
        {
            ...
            DataSet ds = objSearchPurchaseCancellation.fetchallDatasearch("SEARCH_SALES_CANCELLATION", drp_invoice_no.Text, TextBox2.Text, TextBox3.Text);
        ...
        protected void GV_Result_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            Response.Redirect("~/Views/Account/SalesCancellation.aspx?IV=" + invoiceno + "&VT=" + vouchertype);
        }
