<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="PurchaseCancellation.aspx.cs" Inherits="CRM.WebApp.Views.Account.PurchaseCancellation" %>
        ...
        <asp:UpdatePanel ID="update_PurcahseCancellation" runat="server" Visible="true" UpdateMode="Conditional"
            ...
            <ContentTemplate>
                ...
                <table width="800px" id="AccountsVoucher1" runat="server" border="1" style="border-collapse: collapse;
                    ...
                    <tr id="lblgl" style="background-color: #f3f3f3" runat="server" visible="false">
                        <td style="width: 120px">
                    ...
                    <tr style="background-color: #f3f3f3" runat="server" id="trAgainstSalesInvoice">
                        <td style="width: 120px">
                            <asp:Label ID="Label5" runat="server" Text="Aginst Sales Invoice" CssClass="headlabel">
                            </asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="drpsales_Invoice" runat="server" Width="155px" OnSelectedIndexChanged="drpsales_Invoice_SelectedIndexChanged"
                                AutoPostBack="true">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    ...
                    <%----------------------------------------------END------------------------------------------------%>
                    <tr style="background-color: #f3f3f3" id="invoice_no_tr" runat="server">
                        <td>
            ...
            <ContentTemplate>
                <table width="900px" id="AccountsVoucher4" runat="server" border="1" style="border-collapse: collapse;
                    ...
                    <tr id="row1" runat="server" style="width: 1300px">
                        ...
                        <td style="width: 200px">
                            <asp:TextBox ID="row1_txt_credit" runat="server" OnTextChanged="row1_txt_credit_TextChanged" Enabled="false"
                                AutoPostBack="true"></asp:TextBox>
                        </td>
                        <td style="width: 200px">
                    ...
                    <tr id="row2" runat="server" style="width: 1300px; display: none">
                        ...
                        <td style="width: 200px">
                            <asp:TextBox ID="row2_txt_credit" runat="server" Enabled="false"></asp:TextBox>
                        </td>
                        <td style="width: 200px">
                        </td>
                        <td style="width: 100px">
