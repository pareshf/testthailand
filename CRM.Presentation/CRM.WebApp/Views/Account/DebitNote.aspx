<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master"
    AutoEventWireup="true" CodeBehind="DebitNote.aspx.cs" Inherits="CRM.WebApp.Views.Account.DebitNote" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
 ...
 <script language="javascript" type="text/javascript">
    ...
    <div>
        <asp:UpdatePanel ID="update_debitNote" runat="server" Visible="true" UpdateMode="Conditional"
            ChildrenAsTriggers="false">
            <ContentTemplate>
                <asp:Label ID="Label63" runat="server" Text="Debit Note" class="pageTitle" Width="400px"
                ...
                <table width="800px" id="AccountsVoucher1" runat="server" border="1" style="border-collapse: collapse;
                    ...
                    <tr style="background-color: #f3f3f3">
                        <td style="width: 120px">
                            <asp:Label ID="Label5" runat="server" Text="Against Sales Invoice" CssClass="headlabel">
                            </asp:Label>
                        </td>
                        <td>
                    ...
                    <tr style="background-color: #f3f3f3">
                        <td style="width: 120px">
                            <asp:Label ID="Label8" runat="server" Text="Against Purchase Invoice" CssClass="headlabel">
                            </asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="drpPurchaseInvoice" runat="server" Width="155px" OnSelectedIndexChanged="drpPurchaseInvoice_SelectedIndexChanged"
                                AutoPostBack="true">
                            </asp:DropDownList>
                        </td>
                    </tr>
