...
{
    public partial class USDReceipt : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (Request["VN"] != null && !string.IsNullOrEmpty(Request["VN"].ToString()))
                {
                    ...
                    drp_gl_code.Text = ds_for_edit.Tables[0].Rows[0]["GL_DESCRIPTION"].ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else if (ViewState["blankAmountError"] != null)
            {
                Master.DisplayMessage(ViewState["blankAmountError"].ToString(), "successMessage", 8000);
            }
            else
            {
                ...
                if (drpvoucher_type.Text == "RECEIPT")
                {
                    ...
                    else
                    {
                        ...
                        string total_voucher_amount = (decimal.Parse(lbl_row1_credit.Text)).ToString();
                        string total_voucher_debit = (decimal.Parse(lbl_row1_credit.Text)).ToString();
                        ...
                        foreach (GridViewRow item in GridReceipt.Rows)
                        {
                            ...
                            if (chk_onaccount.Checked == true)
                            {
                                ...
                                string voucherAmount = (decimal.Parse(txt_amount.Text) * decimal.Parse(txt_ex_rate.Text)).ToString();
                                objthbreceipt.insert_accounts_entry(0, "0", ViewState["row1_receipt_glcode"].ToString(), drpinvoice.Text, voucherAmount, drpvoucher_type.Text, drp_currency.Text, int.Parse(Session["usersid"].ToString()), txt_narration.Text, int.Parse(Session["usersid"].ToString()), int.Parse(Session["usersid"].ToString()), int.Parse(Session["usersid"].ToString()), "APPROVED", 0, txtAmountSettled.Text, voucherAmount, "", drppayment_mode.Text, txtcheque_no.Text, txt_payment_date.Text, drpbank_name.Text, drpbank_name.Text, "Remarks", txtcash_receipt.Text, txtcashreceipt_date.Text, txt_ex_rate.Text, txt_amount.Text, drp_currency.Text, int.Parse(ViewState["cust_rel_no"].ToString()), int.Parse(Session["CompanyId"].ToString()), txtgl_date.Text, on_acc_flag, 1, false);
                                objthbreceipt.insert_accounts_entry(0, "0", drp_gl_code.Text, "", voucherAmount, drpvoucher_type.Text, drp_currency.Text, int.Parse(Session["usersid"].ToString()), txt_narration.Text, int.Parse(Session["usersid"].ToString()), int.Parse(Session["usersid"].ToString()), int.Parse(Session["usersid"].ToString()), "APPROVED", 0, txt_amount.Text, "", voucherAmount, drppayment_mode.Text, txtcheque_no.Text, txt_payment_date.Text, drpbank_name.Text, drpbank_name.Text, "Remarks", txtcash_receipt.Text, txtcashreceipt_date.Text, txt_ex_rate.Text, txt_amount.Text, drp_currency.Text, int.Parse(ViewState["cust_rel_no"].ToString()), int.Parse(Session["CompanyId"].ToString()), txtgl_date.Text, on_acc_flag, 2, false);
        ...
        protected void updateVoucher()
        {
            ...
            {
                string voucherAmount = (decimal.Parse(txt_amount.Text) * decimal.Parse(txt_ex_rate.Text)).ToString();
                objVouchersStoredProcedure.update_accounts_entry(0, Request["VN"].ToString(), ViewState["row1_receipt_glcode"].ToString(), "", voucherAmount, drpvoucher_type.Text, drp_currency.Text, int.Parse(Session["usersid"].ToString()), txt_narration.Text, int.Parse(Session["usersid"].ToString()), int.Parse(Session["usersid"].ToString()), int.Parse(Session["usersid"].ToString()), drpvoucher_status.Text, int.Parse("0"), "", "", "", drppayment_mode.Text, txtcheque_no.Text, txt_payment_date.Text, drpbank_name.Text, drpbank_name.Text, "Remarks", txtcash_receipt.Text, txtcashreceipt_date.Text, txt_ex_rate.Text, txt_amount.Text, drp_currency.Text, txtgl_date.Text, 1);
                DataSet ds_for_edit = objVouchersStoredProcedure.get_records_for_edit("GET_EDIT_RECEIPT_VOUCHER_DETAILS", Request["VN"].ToString());
                ...
                {
                    string invoiceAmountThb = "";
                    if (txtAmountSettled.Text != "")
                    {
                        invoiceAmountThb = (decimal.Parse(txtAmountSettled.Text) * decimal.Parse(txt_ex_rate.Text)).ToString();
                    }
                    ...
                    if (flag == false)
                    {
                        objVouchersStoredProcedure.update_accounts_entry(0, Request["VN"].ToString(), ViewState["row1_receipt_glcode"].ToString(), drpInvoiceNo.Text, txt_amount.Text, drpvoucher_type.Text, drp_currency.Text, int.Parse(Session["usersid"].ToString()), txt_narration.Text, int.Parse(Session["usersid"].ToString()), int.Parse(Session["usersid"].ToString()), int.Parse(Session["usersid"].ToString()), drpvoucher_status.Text, int.Parse(lblDetailId.Text), txtAmountSettled.Text, invoiceAmountThb, "", drppayment_mode.Text, txtcheque_no.Text, txtcheque_date.Text, drpbank_name.Text, drpbank_name.Text, "Remarks", txtcash_receipt.Text, txtcashreceipt_date.Text, "1", txt_amount.Text, drp_currency.Text, txtgl_date.Text, 2);

                        if (decimal.Parse(txtAmountSettled.Text) == decimal.Parse(lblOldAmount.Text))
                        {

                            insert_voucher_no(drpInvoiceNo.Text);
                            objFITPaymentStoreProcedure.edit_current_usable_MINUS(int.Parse(ViewState["cust_sr_no"].ToString()), decimal.Parse(txtAmountSettled.Text));
                        }

                    }
                    else
                    {
                        objthbreceipt.insert_accounts_entry(0, Request["VN"].ToString(), ViewState["row1_receipt_glcode"].ToString(), drpInvoiceNo.Text, txt_amount.Text, drpvoucher_type.Text, drp_currency.Text, int.Parse(Session["usersid"].ToString()), txt_narration.Text, int.Parse(Session["usersid"].ToString()), int.Parse(Session["usersid"].ToString()), int.Parse(Session["usersid"].ToString()), drpvoucher_status.Text, 0, txtAmountSettled.Text, invoiceAmountThb, "", drppayment_mode.Text, txtcheque_no.Text, txt_payment_date.Text, drpbank_name.Text, drpbank_name.Text, "Remarks", txtcash_receipt.Text, txtcashreceipt_date.Text, "", txt_amount.Text, drp_currency.Text, int.Parse(ViewState["cust_rel_no"].ToString()), int.Parse(Session["CompanyId"].ToString()), txtgl_date.Text, true, 2, false);
                        if (decimal.Parse(txtAmountSettled.Text) == decimal.Parse(lblOldAmount.Text))
                        {
                            insert_voucher_no(drpInvoiceNo.Text);
                            objFITPaymentStoreProcedure.edit_current_usable_MINUS(int.Parse(ViewState["cust_sr_no"].ToString()), decimal.Parse(txtAmountSettled.Text));
        ...
        protected void txtSettledAmount_TextChanged(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow item in GridReceipt.Rows)
            {
                if (item.DataItemIndex == repeaterItemIndex)
                {
                    ...
                    if (lblAmountValidate.Text != "" && txtSettledAmount.Text != "")
                    {
                    ...
                    if (Index == item.DataItemIndex)
                    {
                        if (ViewState["RowCount"] != null)
                        {
                            if (Index <= int.Parse(ViewState["RowCount"].ToString()))
                            {
                                ...
                                DataSet ds1 = objVouchersStoredProcedure.get_invoice_left("FETCH_INVOICE_NO_AGENT_VISE", int.Parse(ds.Tables[0].Rows[0]["CUST_REL_SRNO"].ToString()));
                    ...
                    if (repeaterItemIndex == item.DataItemIndex)
                    {
                        ...
                        if (drpvoucher_type.Text == "RECEIPT")
                        {
                            ...
                            else
                            {
                                ...
                                DataSet ds = objVouchersStoredProcedure.fetch_invoice_dateials("FETCH_DESCRIPTION_FROM_INVOICE_NO_USD", drpinvoice.Text);

                                lblAmountTHB.Text = ds.Tables[0].Rows[0]["VOUCHER_AMOUNT"].ToString();
                                lblStatus.Text = ds.Tables[0].Rows[0]["ORDER_STATUS_NAME"].ToString();
                                lblAmountUSD.Text = ds.Tables[0].Rows[0]["INVOICE_AMOUNT"].ToString();

                                DataSet ds6 = objVouchersStoredProcedure.set_gl_code("FETCH_GENERAL_LEGER_CODE", ds.Tables[0].Rows[0]["CUST_ID"].ToString(), ds.Tables[0].Rows[0]["FLAG"].ToString());
                                ViewState["row1_receipt_glcode"] = ds6.Tables[0].Rows[0]["GL_DESCRIPTION"].ToString();

                                lblBalancetobepaid.Text = get_balance_be_paid(ds.Tables[0].Rows[0]["total_amount"].ToString(), drpinvoice.Text);
        ...
        protected void checkBlankAmount()
        {
            if (Request["VN"] != null && !string.IsNullOrEmpty(Request["VN"].ToString()))
            {
                foreach (GridViewRow item in GridReceipt.Rows)
                {
                    ...
                    if (txtAmountSettled.Text == "")
                    {
                        ViewState["blankAmountError"] = "Please fill Amount Settled for Invoice No : '" + drpinvoice.Text + "'";
                        break;
                    }
                    else
                    {
                        ViewState["blankAmountError"] = null;
                    }
