...
{
    public partial class AgentAllInvoice : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                DataSet ds = objAgentInvoice.FechDataForInvoice("FETCH_ALL_AGENT_INVOICE_DATA", Session["usersid"].ToString());
        ...
        protected void searchnow_onclick(object sender, EventArgs e)
        {
            ...
            DataSet ds = objAgentInvoice.fetchallInvoice("FETCH_DATA_FOR_AGENT_INVOICE_GRID_SERACH", txtrefrence.Text, DropDownList2.Text, TextBox1.Text, TextBox2.Text, TextBox3.Text, Session["usersid"].ToString());
