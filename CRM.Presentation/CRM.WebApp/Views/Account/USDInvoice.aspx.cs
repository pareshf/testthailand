...
{
    public partial class USDInvoice : System.Web.UI.Page
    {
        ...
        protected string[] defaultAmount()
        {
            ...
            foreach (GridViewRow item in GridDetails.Rows)
            {
                ...
                //amount2 = GridDetails.Rows[1].Cells[4].Text.ToString();
                //amount3 = GridDetails.Rows[2].Cells[4].Text.ToString();
                //amount4 = GridDetails.Rows[3].Cells[4].Text.ToString();
                //amount5 = GridDetails.Rows[4].Cells[4].Text.ToString();
