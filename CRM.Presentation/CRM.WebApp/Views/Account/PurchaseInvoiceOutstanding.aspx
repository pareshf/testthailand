<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master"
    AutoEventWireup="true" CodeBehind="PurchaseInvoiceOutstanding.aspx.cs" Inherits="CRM.WebApp.Views.Account.PurchaseInvoiceOutstanding" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
 ...
 <script language="javascript" type="text/javascript">
    ...
    <div>
        <asp:Label runat="server" Text="Search Outstanding Invoices" ID="headlbl" Width="400px"
