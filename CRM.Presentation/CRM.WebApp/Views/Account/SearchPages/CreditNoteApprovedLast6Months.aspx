<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="CreditNoteApprovedLast6Months.aspx.cs" Inherits="CRM.WebApp.Views.Account.SearchPages.CreditNoteApprovedLast6Months" %>
...
<style>
     ...
     <div>
        <asp:Label runat="server" Text="Credit Note Approved Last 6 Months" ID="headlbl" Width="400px" Font-Bold="true"
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="GV_Result" runat="server" OnSelectedIndexChanging="GV_Result_SelectedIndexChanging"
                                AutoGenerateColumns="False" SkinID="sknSubGrid" AllowPaging="true" OnPageIndexChanging="GV_Result_PageIndexChanging" pagesize="10" Width="700px">
                                <pagersettings mode="NumericFirstLast" position="Bottom" pagebuttoncount="10"/>
                                <Columns>
                                    <asp:CommandField ShowSelectButton="True" ButtonType="Button" SelectText="Edit" />
                                    <asp:BoundField DataField="INVOICE_NO" HeaderText="Sales Invoice ID"/>
