...
{
    public partial class PurchaseReturnPrepared : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                DataSet ds2 = objSearchCreditNoteStoredProcedure.fetchallDatasearch("SEARCH_PURCHASE_RETURN_INVOICE", drp_invoice_no.Text, TextBox2.Text, TextBox3.Text, drp_Voucher_type.Text, drp_Voucher_status.Text);
