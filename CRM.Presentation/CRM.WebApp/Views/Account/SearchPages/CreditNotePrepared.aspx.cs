...
{
    public partial class CreditNotePrepared : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                drp_Voucher_status.Text = ds9.Tables[0].Rows[1]["AutoSearchResult"].ToString();
                drp_Voucher_status.Enabled = false;
                binddropdownlist(drp_Voucher_status, ds9);

                DataSet ds2 = objSearchCreditNoteStoredProcedure.fetchallDatasearch("SEARCH_CREDIT_NOTE_INVOICE", drp_invoice_no.Text, TextBox2.Text, TextBox3.Text, drp_Voucher_type.Text, drp_Voucher_status.Text);
