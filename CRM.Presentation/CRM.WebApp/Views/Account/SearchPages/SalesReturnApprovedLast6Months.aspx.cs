...
{
    public partial class SalesReturnApprovedLast6Months : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                binddropdownlist(drp_invoice, ds7);

                DataSet ds8 = objSearchPurchaseInvoice.fetch_supplier_type("FETCH_VOUCHER_TYPE");
                drp_Voucher_types.Text = ds8.Tables[0].Rows[9]["AutoSearchResult"].ToString();
                drp_Voucher_types.Enabled = false;
                binddropdownlist(drp_Voucher_types, ds8);

                DataSet ds9 = objSearchPurchaseInvoice.fetch_supplier_type("FETCH_VOUCHER_STATUS_ID");
                drp_Voucher_status1.Text = ds9.Tables[0].Rows[2]["AutoSearchResult"].ToString();
                drp_Voucher_status1.Enabled = false;
                binddropdownlist(drp_Voucher_status1, ds9);
                ...
                DataSet ds2 = objSearchCreditNoteStoredProcedure.fetchallDatasearch("SEARCH_SALES_RETURN_INVOICE", drp_invoice.Text, ViewState["Duration_From"].ToString(), d1, drp_Voucher_types.Text, drp_Voucher_status1.Text);
        ...
        protected void searchnow_onclick(object sender, EventArgs e)
        {
            ...
            if (TextBox2.Text != "")
            {
                ...
                DataSet ds = objSearchCreditNoteStoredProcedure.fetchallDatasearch("SEARCH_SALES_RETURN_INVOICE", drp_invoice.Text, TextBox2.Text, TextBox3.Text, drp_Voucher_types.Text, drp_Voucher_status1.Text);
            ...
            else
            {
                ...
                DataSet ds = objSearchCreditNoteStoredProcedure.fetchallDatasearch("SEARCH_SALES_RETURN_INVOICE", drp_invoice.Text, ViewState["Duration_From"].ToString(), TextBox3.Text, drp_Voucher_types.Text, drp_Voucher_status1.Text);
                pnlMainHead.Attributes.Add("style", "display:none");
                Button4.Attributes.Add("style", "display:none");
                Button3.Attributes.Add("style", "display");
                GV_Result.DataSource = ds.Tables[0];
