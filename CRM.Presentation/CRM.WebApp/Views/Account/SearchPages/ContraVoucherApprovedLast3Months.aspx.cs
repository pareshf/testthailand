...
{
    public partial class ContraVoucherApprovedLast3Months : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                DataSet ds2 = objContraVoucher.fetchallDatasearch("FETCH_ALL_CONTRA_VOUCHER", drp_voucher_status.Text, drp_voucher_type.Text, ViewState["Duration_From"].ToString(), d1);
        ...
        protected void searchnow_onclick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DataSet ds = objContraVoucher.fetchallDatasearch("FETCH_ALL_CONTRA_VOUCHER", drp_voucher_status.Text, drp_voucher_type.Text, ViewState["Duration_From"].ToString(), TextBox3.Text);
                pnlMainHead.Attributes.Add("style", "display:none");
                Button4.Attributes.Add("style", "display:none");
                Button3.Attributes.Add("style", "display");
                GV_Result.DataSource = ds.Tables[0];
