...
{
    public partial class CreditNotePostedLast6Months : System.Web.UI.Page
    {
        ...
        protected void Page_PreInit(object sender, EventArgs e)
        {
            ...
            DataTable dt = objAuthorizationDal.GetPageRights(Convert.ToInt32(CompId), Convert.ToInt32(DeptId), Convert.ToInt32(RoleId), 271);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                DataSet ds7 = objSearchPurchaseInvoice.fetch_supplier_type("FETCH_ALL_INVOICE_CREDIT_NOTE");
                binddropdownlist(drp_invoice_no, ds7);

                DataSet ds8 = objSearchPurchaseInvoice.fetch_supplier_type("FETCH_VOUCHER_TYPE");
                drp_Voucher_type.Text = ds8.Tables[0].Rows[2]["AutoSearchResult"].ToString();
                ...
                drp_Voucher_status.Text = ds9.Tables[0].Rows[0]["AutoSearchResult"].ToString();
                ...
                DataSet ds2 = objSearchCreditNoteStoredProcedure.fetchallDatasearch("SEARCH_CREDIT_NOTE_INVOICE", drp_invoice_no.Text, ViewState["Duration_From"].ToString(), d1, drp_Voucher_type.Text, drp_Voucher_status.Text);
        ...
        protected void searchnow_onclick(object sender, EventArgs e)
        {
            ...
            if (TextBox2.Text != "")
            {
                ...
                DataSet ds = objSearchCreditNoteStoredProcedure.fetchallDatasearch("SEARCH_CREDIT_NOTE_INVOICE", drp_invoice_no.Text, TextBox2.Text, TextBox3.Text, drp_Voucher_type.Text, drp_Voucher_status.Text);
            ...
            else
            {
                ...
                DataSet ds = objSearchCreditNoteStoredProcedure.fetchallDatasearch("SEARCH_CREDIT_NOTE_INVOICE", drp_invoice_no.Text, ViewState["Duration_From"].ToString(), TextBox3.Text, drp_Voucher_type.Text, drp_Voucher_status.Text);
                pnlMainHead.Attributes.Add("style", "display:none");
                Button4.Attributes.Add("style", "display:none");
                Button3.Attributes.Add("style", "display");
                GV_Result.DataSource = ds.Tables[0];
