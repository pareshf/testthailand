...
{
    public partial class ReceiptVoucherApprovedLast6Months : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet ds2 = objSearchReceiptVouchersStoredProcedure.fetchallDatasearch("SEARCH_RECEIPT_VOUCHER", drp_invoice_no.Text, drp_voucher_status.Text, drp_voucher_type.Text, drp_gl_code.Text, ViewState["Duration_From"].ToString(), d1);
        ...
        protected void searchnow_onclick(object sender, EventArgs e)
        {
            ...
            if (txtfromdate.Text != "")
            {
                ...
                DataSet ds = objSearchReceiptVouchersStoredProcedure.fetchallDatasearch("SEARCH_RECEIPT_VOUCHER", drp_invoice_no.Text, drp_voucher_status.Text, drp_voucher_type.Text, drp_gl_code.Text, txtfromdate.Text, txttodate.Text);
            ...
            else
            {
                ...
                DataSet ds = objSearchReceiptVouchersStoredProcedure.fetchallDatasearch("SEARCH_RECEIPT_VOUCHER", drp_invoice_no.Text, drp_voucher_status.Text, drp_voucher_type.Text, drp_gl_code.Text, ViewState["Duration_From"].ToString(), txttodate.Text);
                pnlMainHead.Attributes.Add("style", "display:none");
                Button4.Attributes.Add("style", "display:none");
                Button3.Attributes.Add("style", "display");
                GV_Result.DataSource = ds.Tables[0];
