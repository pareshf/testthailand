<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master"
    AutoEventWireup="true" CodeBehind="SearchSightSeeing.aspx.cs" Inherits="CRM.WebApp.Views.Account.SearchSightSeeing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
 ...
 <script language="javascript" type="text/javascript">
    ...
    <div>
        <asp:Label runat="server" Text="SightSeeing Service Voucher" ID="headlbl" Width="400px"
                ...
                <asp:Panel ID="pnlMainHead" runat="server" Style="display: none">
                    <table>
                        ...
                        <tr style="display: none">
                            <td width="180px">
                                <asp:Label ID="Label4" runat="server" Text="Date" CssClass="lblstyle"></asp:Label>
                            </td>
                            <td>
