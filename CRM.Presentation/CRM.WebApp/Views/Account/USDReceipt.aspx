<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="USDReceipt.aspx.cs" Inherits="CRM.WebApp.Views.Account.USDReceipt" %>
            ...
            <ContentTemplate>
                <table width="800px" id="AccountsVoucher1" runat="server" border="1" style="border-collapse: collapse;
                    ...
                    <tr style="background-color: #f3f3f3">
                        ...
                        <td>
                            <asp:TextBox ID="txtgl_date" runat="server" AutoPostBack="true" ></asp:TextBox>
            ...
            <ContentTemplate>
                <asp:GridView ID="GridReceipt" runat="server" AutoGenerateColumns="false" HeaderStyle-BackColor="Silver"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ControlStyle-Width="100px">
                            <HeaderTemplate>
                                <asp:Label ID="lblAmtUSD" runat="server" Text="Invoice Amount [USD]" CssClass="lblstyleGIT"></asp:Label>
                            </HeaderTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblAmountUSD" runat="server" Text=""></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField ControlStyle-Width="100px">
                            <HeaderTemplate>
                                <asp:Label ID="lblBaltobepaid" runat="server" Text="Balance to be paid [USD]" CssClass="lblstyleGIT"></asp:Label>
                            </HeaderTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField ControlStyle-Width="100px">
                            <HeaderTemplate>
                                <asp:Label ID="lblInvoiceStatus" runat="server" Text="Status" CssClass="lblstyleGIT"></asp:Label>
                            </HeaderTemplate>
                            <ItemTemplate>
