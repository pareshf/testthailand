<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="USDInvoice.aspx.cs" Inherits="CRM.WebApp.Views.Account.USDInvoice" %>
                    ...
                    <tr>
                            ...
                            <table style="border-collapse: collapse; border-color: #E6E6E6 #E6E6E6 #CCCCCC" cellspacing="5"
                                ...
                                <tr>
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <asp:Button ID="btnCopy" runat="server" Text="Copy Booking" OnClick="btnCopy_Click" Visible="false"/>
                                    </td>
                        ...
                        <td width="60%" valign="top">
                            ...
                            <table>
                                <tr>
                                    <td>
                                     <asp:GridView ID="GridDetails" runat="server" AutoGenerateColumns="false" Width="100%" HeaderStyle-BackColor="Silver">
                                <Columns>   
                                    <asp:TemplateField ControlStyle-Width="200px">
                                        <HeaderTemplate>
                                            <asp:Label ID="lblGridDescription" runat="server" Text="Invoice Description" CssClass="lblstyleGIT"></asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                      ...
                                      <asp:TemplateField ControlStyle-Width="100px">
                                        <HeaderTemplate>
                                            <asp:Label ID="lblGridUnitNo" runat="server" Text="Unit No." CssClass="lblstyleGIT"></asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtUnitNo" OnTextChanged="txtUnitNo_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField ControlStyle-Width="100px">
                                        <HeaderTemplate>
                                            <asp:Label ID="lblGridAmoutPerPerson" runat="server" Text="Amount Per Person[USD]" CssClass="lblstyleGIT"></asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField ControlStyle-Width="100px">
                                        <HeaderTemplate>
                                            <asp:Label ID="lblGridAmount" runat="server" Text="Total Amount[USD]" CssClass="lblstyleGIT"></asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblGridTotalAmount" runat="server" CssClass="lblstyleGIT"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
