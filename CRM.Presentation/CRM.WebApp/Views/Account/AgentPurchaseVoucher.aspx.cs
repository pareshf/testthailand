...
{
    public partial class AgentPurchaseVoucher : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if(!IsPostBack)
            {
                ...
                DataSet ds2 = objAgentpurchaseVoucher.fetchAgentVoucher("FETCH_AGENT_PURCHASE_VOUCHER", drp_invoice_no.Text, drp_voucher_status.Text, drp_voucher_type.Text, TextBox2.Text, TextBox3.Text, int.Parse(Session["cust_id"].ToString()));
        ...
        {
            DataSet ds3 = objAgentpurchaseVoucher.fetchAgentVoucher("FETCH_AGENT_PURCHASE_VOUCHER", drp_invoice_no.Text, drp_voucher_status.Text, drp_voucher_type.Text, TextBox2.Text, TextBox3.Text, int.Parse(Session["cust_id"].ToString()));
        ...
        protected void GV_Result_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            DataSet ds4 = objAgentpurchaseVoucher.fetchAgentVoucher("FETCH_AGENT_PURCHASE_VOUCHER", drp_invoice_no.Text, drp_voucher_status.Text, drp_voucher_type.Text, TextBox2.Text, TextBox3.Text, int.Parse(Session["cust_id"].ToString()));
