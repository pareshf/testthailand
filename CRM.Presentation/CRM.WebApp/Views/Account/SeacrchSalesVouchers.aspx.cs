...
{
    public partial class SeacrchSalesVouchers : System.Web.UI.Page
    {
        ...
        protected void searchnow_onclick(object sender, EventArgs e)
        {
            ...
            DataSet ds = objSearchSalesVoucherStoredProcedure.fetchallDatasearch("FETCH_ALL_SALES_PURCHASE_DATA", drp_invoice_no.Text, drp_voucher_status.Text, drp_voucher_type.Text, TextBox2.Text, TextBox3.Text);
