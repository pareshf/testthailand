<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="MySalesVoucher.aspx.cs" Inherits="CRM.WebApp.Views.Account.MySalesVoucher" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageContent" runat="server">
 ...
 <script language="javascript" type="text/javascript">
     ...
     <div>
        <asp:Label runat="server" Text="My Sales Voucher" ID="headlbl" Width="400px" Font-Bold="true"
