...
{
    public partial class SearchContraVoucher : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //DataSet ds2 = objContraVoucher.fetchallDatasearch("FETCH_ALL_CONTRA_VOUCHER", drp_invoice_no.Text, drp_voucher_status.Text, drp_voucher_type.Text, TextBox2.Text, TextBox3.Text);
        ...
        protected void searchnow_onclick(object sender, EventArgs e)
        {
            ...
            //DataSet ds = objContraVoucher.fetchallDatasearch("FETCH_ALL_CONTRA_VOUCHER", drp_invoice_no.Text, drp_voucher_status.Text, drp_voucher_type.Text, TextBox2.Text, TextBox3.Text);
