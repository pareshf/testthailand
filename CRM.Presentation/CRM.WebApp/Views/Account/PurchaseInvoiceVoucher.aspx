        ...
        <asp:UpdatePanel ID="UpdatePanel_Generate_Invoice" runat="server" UpdateMode="Conditional"
            ...
            <ContentTemplate>
                <table style="border-collapse: collapse; border-color: #E6E6E6 #E6E6E6 #CCCCCC" cellspacing="5"
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lblArrivalDate" runat="server" Text="Arrival Date" CssClass="lblstyle"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtArrivalDate" runat="server" Width="250px"></asp:TextBox>
                            <ajax:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender2" runat="server" TargetControlID="txtArrivalDate"
                                WatermarkText="dd/MM/yyyy" WatermarkCssClass="watermarked">
                            </ajax:TextBoxWatermarkExtender>
                              <ajax:calendarextender id="CalendarExtender1" runat="server" targetcontrolid="txtArrivalDate"
                                    format="dd/MM/yyyy" popupbuttonid="Image1" />
                        </td>
                    </tr>
                     <tr>
                        <td>
                            <asp:Label ID="lbldeparture" runat="server" Text="Departure Date" CssClass="lblstyle"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtdeparturedate" runat="server" Width="250px"></asp:TextBox>
                            <ajax:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender3" runat="server" TargetControlID="txtdeparturedate"
                                WatermarkText="dd/MM/yyyy" WatermarkCssClass="watermarked">
                            </ajax:TextBoxWatermarkExtender>
                              <ajax:calendarextender id="CalendarExtender2" runat="server" targetcontrolid="txtdeparturedate"
                                    format="dd/MM/yyyy" popupbuttonid="Image1" />
                        </td>
                    </tr>
                     <tr>
                        <td>
                            <asp:Label ID="lblServicedate" runat="server" Text="Service Date" CssClass="lblstyle"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtservicedate" runat="server" Width="250px"></asp:TextBox>
                            <ajax:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender4" runat="server" TargetControlID="txtservicedate"
                                WatermarkText="dd/MM/yyyy" WatermarkCssClass="watermarked">
                            </ajax:TextBoxWatermarkExtender>
                              <ajax:calendarextender id="CalendarExtender3" runat="server" targetcontrolid="txtservicedate"
                                    format="dd/MM/yyyy" popupbuttonid="Image1" />
                        </td>
                    </tr>
                    <%--End add new--%>
