...
{
    public partial class AgentMyInvoice : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                DataSet ds = objAgentInvoice.FechDataForInvoice("FETCH_ALL_INVOICE_DATA_FOR_AGENT", Session["usersid"].ToString());
        ...
        protected void GV_Result_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
           ...
           // ScriptManager.RegisterStartupScript(this, typeof(string), "OPEN_WINDOW", "window.open( 'DownloadInvoice.aspx', null, 'height=1000,width=800,status=yes,toolbar=no,menubar=no,location=no' );", true);
        }
        ...
        protected void searchnow_onclick(object sender, EventArgs e)
        {
            ...
            DataSet ds = objAgentInvoice.fetchallInvoice("GET_ALL_INVOICE_FOR_AGENT", txtrefrence.Text, DropDownList2.Text, TextBox1.Text, TextBox2.Text, TextBox3.Text, Session["usersid"].ToString());
