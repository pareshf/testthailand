...
namespace CRM.WebApp.Views.Account
{
    public partial class AgentClosedInvoice : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                DataSet ds = objAgentInvoice.FechDataForInvoice("FETCH_AGENT_ALL_CLOSED_INVOICE", Session["usersid"].ToString());
        ...
        protected void searchnow_onclick(object sender, EventArgs e)
        {
            ...
            DataSet ds = objAgentInvoice.fetchallInvoice("FETCH_DATA_FOR_AGENT_CLOSED_INVOICE_GRID_SERACH", txtrefrence.Text, DropDownList2.Text, TextBox1.Text, TextBox2.Text, TextBox3.Text, Session["usersid"].ToString());
