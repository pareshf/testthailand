...
{
    public partial class RoomAllocationReportCountryWise : System.Web.UI.Page
    {
        string tourid = "";
        string countryid = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            countryid = Page.Request.QueryString["key1"].ToString();

            ReportParameter[] parm = new ReportParameter[1];
            parm[0] = new ReportParameter("TOUR_ID", tourid);
            parm[1] = new ReportParameter("COUNTRY_ID", countryid);
