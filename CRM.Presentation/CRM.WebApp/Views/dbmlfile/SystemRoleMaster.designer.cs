...
namespace CRM.WebApp.Views.dbmlfile
{
	...
	public partial class SystemRoleMasterDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void OnCreated();
		...
		public SystemRoleMasterDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["CRM"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public SystemRoleMasterDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public SystemRoleMasterDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public SystemRoleMasterDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public SystemRoleMasterDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public System.Data.Linq.Table<VIEW_FOR_SYS_ROLE_MASTER> VIEW_FOR_SYS_ROLE_MASTERs
		{
			get
			{
				return this.GetTable<VIEW_FOR_SYS_ROLE_MASTER>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.VIEW_FOR_SYS_ROLE_MASTER")]
	public partial class VIEW_FOR_SYS_ROLE_MASTER
	{
		...
		public VIEW_FOR_SYS_ROLE_MASTER()
		{
		}
