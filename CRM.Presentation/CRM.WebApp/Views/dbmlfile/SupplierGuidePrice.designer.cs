...
namespace CRM.WebApp.Views.dbmlfile
{
	...
	public partial class SupplierGuidePriceDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void OnCreated();
		...
		public SupplierGuidePriceDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["CRM"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public SupplierGuidePriceDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public SupplierGuidePriceDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public SupplierGuidePriceDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public SupplierGuidePriceDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public System.Data.Linq.Table<VIEW_SUPPLIER_GUIDE_PRICE_LIST> VIEW_SUPPLIER_GUIDE_PRICE_LISTs
		{
			get
			{
				return this.GetTable<VIEW_SUPPLIER_GUIDE_PRICE_LIST>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.VIEW_SUPPLIER_GUIDE_PRICE_LIST")]
	public partial class VIEW_SUPPLIER_GUIDE_PRICE_LIST
	{
		
		private int _GUIDE_PRICE_LIST_ID;
		...
		public VIEW_SUPPLIER_GUIDE_PRICE_LIST()
		{
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_GUIDE_PRICE_LIST_ID", DbType="Int NOT NULL")]
		public int GUIDE_PRICE_LIST_ID
		{
			get
			{
				return this._GUIDE_PRICE_LIST_ID;
			}
			set
			{
				if ((this._GUIDE_PRICE_LIST_ID != value))
				{
					this._GUIDE_PRICE_LIST_ID = value;
				}
			}
		}
