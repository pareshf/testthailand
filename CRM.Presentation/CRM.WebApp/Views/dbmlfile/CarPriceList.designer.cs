...
namespace CRM.WebApp.Views.dbmlfile
{
	...
	public partial class CarPriceListDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void OnCreated();
		...
		public CarPriceListDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["CRM"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public CarPriceListDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public CarPriceListDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public CarPriceListDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public CarPriceListDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public System.Data.Linq.Table<VIEW_SUPPLIER_CAR_PRICE_LIST> VIEW_SUPPLIER_CAR_PRICE_LISTs
		{
			get
			{
				return this.GetTable<VIEW_SUPPLIER_CAR_PRICE_LIST>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.VIEW_SUPPLIER_CAR_PRICE_LIST")]
	public partial class VIEW_SUPPLIER_CAR_PRICE_LIST
	{
		
		private int _CAR_PRICE_LIST_MASTER_ID;
		...
		private string _RATE_UNIT_NAME;
		
		public VIEW_SUPPLIER_CAR_PRICE_LIST()
		{
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CAR_PRICE_LIST_MASTER_ID", DbType="Int NOT NULL")]
		public int CAR_PRICE_LIST_MASTER_ID
		{
			get
			{
				return this._CAR_PRICE_LIST_MASTER_ID;
			}
			set
			{
				if ((this._CAR_PRICE_LIST_MASTER_ID != value))
				{
					this._CAR_PRICE_LIST_MASTER_ID = value;
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CAR_NAME", DbType="VarChar(50)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_RATE_UNIT_NAME", DbType="VarChar(50)")]
		public string RATE_UNIT_NAME
		{
			get
			{
				return this._RATE_UNIT_NAME;
			}
			set
			{
				if ((this._RATE_UNIT_NAME != value))
				{
					this._RATE_UNIT_NAME = value;
				}
			}
		}
	}
