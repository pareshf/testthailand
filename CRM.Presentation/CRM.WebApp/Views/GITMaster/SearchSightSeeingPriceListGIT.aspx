<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CRMMaster.Master" AutoEventWireup="true" CodeBehind="SearchSightSeeingPriceListGIT.aspx.cs" Inherits="CRM.WebApp.Views.GITMaster.SearchSightSeeingPriceListGIT" %>
...
<style>
     ...
     <div>
        ...
        <asp:UpdatePanel ID="UpSight" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false"
            class="pageTitle">
            <ContentTemplate>
                <table>
                    <tr>
                ...
                <asp:Panel ID="pnlMainHead" runat="server" Style="display: none">
                    <table width="600px" border="1" style="border-collapse: collapse; border-color: #E6E6E6 #E6E6E6 #CCCCCC" cellspacing="5" cellpadding="5">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="drpCity" runat="server" Width="255px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td width="180px">
                                <asp:Label ID="Label1" runat="server" Text="Supplier" CssClass="lblstyle"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td width="180px">
                                <asp:Label ID="Label4" runat="server" Text="SightSeeing Package" CssClass="lblstyle"></asp:Label>
                            </td>
                            <td>
                ...
                <table width="100%">
                    <tr>
                        <td>
                            <asp:GridView ID="GV_sightPriceList" runat="server" OnSelectedIndexChanging="GV_HotelPriceList_SelectedIndexChanging"
                                AutoGenerateColumns="False" SkinID="sknSubGrid" AllowPaging="true" OnPageIndexChanging="GV_HotelPriceList_PageIndexChanging" pagesize="10" Width="1000px">
                                <pagersettings mode="NumericFirstLast" position="Bottom" pagebuttoncount="10"/>
                                <Columns>
                                    <asp:CommandField ShowSelectButton="True" ButtonType="Button" SelectText="Edit"/>
                                    
                                    <asp:BoundField DataField="SUPPLIER_COMPANY_NAME" HeaderText="Supplier" />
                                    <asp:BoundField DataField="CUST_COMPANY_NAME" HeaderText="Agent" />
                                    <asp:BoundField DataField="CITY_NAME" HeaderText="City" />
                                    <asp:BoundField DataField="EFFECTIVE_FROM_DATE" HeaderText="From Date" />
                                    <asp:BoundField DataField="EFFECTIVE_TO_DATE" HeaderText="To Date" />
                                    <asp:BoundField DataField="SIGHT_SEEING_PRICE_ID" HeaderText="Sight Price Id" />
                                </Columns>
